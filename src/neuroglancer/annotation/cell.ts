...
/**
 * @file Support for rendering cell annotations.
 */

 import {AnnotationType, Cell} from 'neuroglancer/annotation';
 ...
 class RenderHelper extends AnnotationRenderHelper {
   private defineShaderCommon(builder: ShaderBuilder) {
     const {rank} = this;
     // Position of cell in model coordinates.
 ...
 `);
   ...
   private shaderGetter3d =
       this.getDependentShader('annotation/cell:3d', (builder: ShaderBuilder) => {
 ...
 `);
   ...
   private makeShaderGetter2d = (extraDim: number) =>
       this.getDependentShader(`annotation/cell:2d:${extraDim}`, (builder: ShaderBuilder) => {
         defineVertexId(builder);
 ...
 registerAnnotationTypeRenderHandler<Cell>(AnnotationType.CELL, {
