[neuroglancer](../README.md) / [Exports](../modules.md) / [main\_module](../modules/main_module.md) / [<internal\>](../modules/main_module._internal_.md) / SVGFEConvolveMatrixElement

# Interface: SVGFEConvolveMatrixElement

[main_module](../modules/main_module.md).[<internal>](../modules/main_module._internal_.md).SVGFEConvolveMatrixElement
...
- [`SVGFilterPrimitiveStandardAttributes`](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md)
...
- [ATTRIBUTE\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#cdata_section_node)
- [COMMENT\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#document_fragment_node)
- [DOCUMENT\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](main_module._internal_.SVGFEConvolveMatrixElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](main_module._internal_.SVGFEConvolveMatrixElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](main_module._internal_.SVGFEConvolveMatrixElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](main_module._internal_.SVGFEConvolveMatrixElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](main_module._internal_.SVGFEConvolveMatrixElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](main_module._internal_.SVGFEConvolveMatrixElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#document_type_node)
- [ELEMENT\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#element_node)
- [ENTITY\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#entity_reference_node)
- [NOTATION\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#processing_instruction_node)
- [SVG\_EDGEMODE\_DUPLICATE](main_module._internal_.SVGFEConvolveMatrixElement.md#svg_edgemode_duplicate)
- [SVG\_EDGEMODE\_NONE](main_module._internal_.SVGFEConvolveMatrixElement.md#svg_edgemode_none)
- [SVG\_EDGEMODE\_UNKNOWN](main_module._internal_.SVGFEConvolveMatrixElement.md#svg_edgemode_unknown)
- [SVG\_EDGEMODE\_WRAP](main_module._internal_.SVGFEConvolveMatrixElement.md#svg_edgemode_wrap)
- [TEXT\_NODE](main_module._internal_.SVGFEConvolveMatrixElement.md#text_node)
- [ariaAtomic](main_module._internal_.SVGFEConvolveMatrixElement.md#ariaatomic)
- [ariaAutoComplete](main_module._internal_.SVGFEConvolveMatrixElement.md#ariaautocomplete)
- [ariaBusy](main_module._internal_.SVGFEConvolveMatrixElement.md#ariabusy)
- [ariaChecked](main_module._internal_.SVGFEConvolveMatrixElement.md#ariachecked)
- [ariaColCount](main_module._internal_.SVGFEConvolveMatrixElement.md#ariacolcount)
- [ariaColIndex](main_module._internal_.SVGFEConvolveMatrixElement.md#ariacolindex)
- [ariaColSpan](main_module._internal_.SVGFEConvolveMatrixElement.md#ariacolspan)
- [ariaCurrent](main_module._internal_.SVGFEConvolveMatrixElement.md#ariacurrent)
- [ariaDisabled](main_module._internal_.SVGFEConvolveMatrixElement.md#ariadisabled)
- [ariaExpanded](main_module._internal_.SVGFEConvolveMatrixElement.md#ariaexpanded)
- [ariaHasPopup](main_module._internal_.SVGFEConvolveMatrixElement.md#ariahaspopup)
- [ariaHidden](main_module._internal_.SVGFEConvolveMatrixElement.md#ariahidden)
- [ariaKeyShortcuts](main_module._internal_.SVGFEConvolveMatrixElement.md#ariakeyshortcuts)
- [ariaLabel](main_module._internal_.SVGFEConvolveMatrixElement.md#arialabel)
- [ariaLevel](main_module._internal_.SVGFEConvolveMatrixElement.md#arialevel)
- [ariaLive](main_module._internal_.SVGFEConvolveMatrixElement.md#arialive)
- [ariaModal](main_module._internal_.SVGFEConvolveMatrixElement.md#ariamodal)
- [ariaMultiLine](main_module._internal_.SVGFEConvolveMatrixElement.md#ariamultiline)
- [ariaMultiSelectable](main_module._internal_.SVGFEConvolveMatrixElement.md#ariamultiselectable)
- [ariaOrientation](main_module._internal_.SVGFEConvolveMatrixElement.md#ariaorientation)
- [ariaPlaceholder](main_module._internal_.SVGFEConvolveMatrixElement.md#ariaplaceholder)
- [ariaPosInSet](main_module._internal_.SVGFEConvolveMatrixElement.md#ariaposinset)
- [ariaPressed](main_module._internal_.SVGFEConvolveMatrixElement.md#ariapressed)
- [ariaReadOnly](main_module._internal_.SVGFEConvolveMatrixElement.md#ariareadonly)
- [ariaRequired](main_module._internal_.SVGFEConvolveMatrixElement.md#ariarequired)
- [ariaRoleDescription](main_module._internal_.SVGFEConvolveMatrixElement.md#ariaroledescription)
- [ariaRowCount](main_module._internal_.SVGFEConvolveMatrixElement.md#ariarowcount)
- [ariaRowIndex](main_module._internal_.SVGFEConvolveMatrixElement.md#ariarowindex)
- [ariaRowSpan](main_module._internal_.SVGFEConvolveMatrixElement.md#ariarowspan)
- [ariaSelected](main_module._internal_.SVGFEConvolveMatrixElement.md#ariaselected)
- [ariaSetSize](main_module._internal_.SVGFEConvolveMatrixElement.md#ariasetsize)
- [ariaSort](main_module._internal_.SVGFEConvolveMatrixElement.md#ariasort)
- [ariaValueMax](main_module._internal_.SVGFEConvolveMatrixElement.md#ariavaluemax)
- [ariaValueMin](main_module._internal_.SVGFEConvolveMatrixElement.md#ariavaluemin)
- [ariaValueNow](main_module._internal_.SVGFEConvolveMatrixElement.md#ariavaluenow)
- [ariaValueText](main_module._internal_.SVGFEConvolveMatrixElement.md#ariavaluetext)
- [assignedSlot](main_module._internal_.SVGFEConvolveMatrixElement.md#assignedslot)
- [attributes](main_module._internal_.SVGFEConvolveMatrixElement.md#attributes)
- [autofocus](main_module._internal_.SVGFEConvolveMatrixElement.md#autofocus)
- [baseURI](main_module._internal_.SVGFEConvolveMatrixElement.md#baseuri)
- [bias](main_module._internal_.SVGFEConvolveMatrixElement.md#bias)
- [childElementCount](main_module._internal_.SVGFEConvolveMatrixElement.md#childelementcount)
- [childNodes](main_module._internal_.SVGFEConvolveMatrixElement.md#childnodes)
- [children](main_module._internal_.SVGFEConvolveMatrixElement.md#children)
- [classList](main_module._internal_.SVGFEConvolveMatrixElement.md#classlist)
- [className](main_module._internal_.SVGFEConvolveMatrixElement.md#classname)
- [clientHeight](main_module._internal_.SVGFEConvolveMatrixElement.md#clientheight)
- [clientLeft](main_module._internal_.SVGFEConvolveMatrixElement.md#clientleft)
- [clientTop](main_module._internal_.SVGFEConvolveMatrixElement.md#clienttop)
- [clientWidth](main_module._internal_.SVGFEConvolveMatrixElement.md#clientwidth)
- [dataset](main_module._internal_.SVGFEConvolveMatrixElement.md#dataset)
- [divisor](main_module._internal_.SVGFEConvolveMatrixElement.md#divisor)
- [edgeMode](main_module._internal_.SVGFEConvolveMatrixElement.md#edgemode)
- [firstChild](main_module._internal_.SVGFEConvolveMatrixElement.md#firstchild)
- [firstElementChild](main_module._internal_.SVGFEConvolveMatrixElement.md#firstelementchild)
- [height](main_module._internal_.SVGFEConvolveMatrixElement.md#height)
- [id](main_module._internal_.SVGFEConvolveMatrixElement.md#id)
- [in1](main_module._internal_.SVGFEConvolveMatrixElement.md#in1)
- [innerHTML](main_module._internal_.SVGFEConvolveMatrixElement.md#innerhtml)
- [isConnected](main_module._internal_.SVGFEConvolveMatrixElement.md#isconnected)
- [kernelMatrix](main_module._internal_.SVGFEConvolveMatrixElement.md#kernelmatrix)
- [kernelUnitLengthX](main_module._internal_.SVGFEConvolveMatrixElement.md#kernelunitlengthx)
- [kernelUnitLengthY](main_module._internal_.SVGFEConvolveMatrixElement.md#kernelunitlengthy)
- [lastChild](main_module._internal_.SVGFEConvolveMatrixElement.md#lastchild)
- [lastElementChild](main_module._internal_.SVGFEConvolveMatrixElement.md#lastelementchild)
- [localName](main_module._internal_.SVGFEConvolveMatrixElement.md#localname)
- [namespaceURI](main_module._internal_.SVGFEConvolveMatrixElement.md#namespaceuri)
- [nextElementSibling](main_module._internal_.SVGFEConvolveMatrixElement.md#nextelementsibling)
- [nextSibling](main_module._internal_.SVGFEConvolveMatrixElement.md#nextsibling)
- [nodeName](main_module._internal_.SVGFEConvolveMatrixElement.md#nodename)
- [nodeType](main_module._internal_.SVGFEConvolveMatrixElement.md#nodetype)
- [nodeValue](main_module._internal_.SVGFEConvolveMatrixElement.md#nodevalue)
- [nonce](main_module._internal_.SVGFEConvolveMatrixElement.md#nonce)
- [onabort](main_module._internal_.SVGFEConvolveMatrixElement.md#onabort)
- [onanimationcancel](main_module._internal_.SVGFEConvolveMatrixElement.md#onanimationcancel)
- [onanimationend](main_module._internal_.SVGFEConvolveMatrixElement.md#onanimationend)
- [onanimationiteration](main_module._internal_.SVGFEConvolveMatrixElement.md#onanimationiteration)
- [onanimationstart](main_module._internal_.SVGFEConvolveMatrixElement.md#onanimationstart)
- [onauxclick](main_module._internal_.SVGFEConvolveMatrixElement.md#onauxclick)
- [onblur](main_module._internal_.SVGFEConvolveMatrixElement.md#onblur)
- [oncanplay](main_module._internal_.SVGFEConvolveMatrixElement.md#oncanplay)
- [oncanplaythrough](main_module._internal_.SVGFEConvolveMatrixElement.md#oncanplaythrough)
- [onchange](main_module._internal_.SVGFEConvolveMatrixElement.md#onchange)
- [onclick](main_module._internal_.SVGFEConvolveMatrixElement.md#onclick)
- [onclose](main_module._internal_.SVGFEConvolveMatrixElement.md#onclose)
- [oncontextmenu](main_module._internal_.SVGFEConvolveMatrixElement.md#oncontextmenu)
- [oncopy](main_module._internal_.SVGFEConvolveMatrixElement.md#oncopy)
- [oncuechange](main_module._internal_.SVGFEConvolveMatrixElement.md#oncuechange)
- [oncut](main_module._internal_.SVGFEConvolveMatrixElement.md#oncut)
- [ondblclick](main_module._internal_.SVGFEConvolveMatrixElement.md#ondblclick)
- [ondrag](main_module._internal_.SVGFEConvolveMatrixElement.md#ondrag)
- [ondragend](main_module._internal_.SVGFEConvolveMatrixElement.md#ondragend)
- [ondragenter](main_module._internal_.SVGFEConvolveMatrixElement.md#ondragenter)
- [ondragleave](main_module._internal_.SVGFEConvolveMatrixElement.md#ondragleave)
- [ondragover](main_module._internal_.SVGFEConvolveMatrixElement.md#ondragover)
- [ondragstart](main_module._internal_.SVGFEConvolveMatrixElement.md#ondragstart)
- [ondrop](main_module._internal_.SVGFEConvolveMatrixElement.md#ondrop)
- [ondurationchange](main_module._internal_.SVGFEConvolveMatrixElement.md#ondurationchange)
- [onemptied](main_module._internal_.SVGFEConvolveMatrixElement.md#onemptied)
- [onended](main_module._internal_.SVGFEConvolveMatrixElement.md#onended)
- [onerror](main_module._internal_.SVGFEConvolveMatrixElement.md#onerror)
- [onfocus](main_module._internal_.SVGFEConvolveMatrixElement.md#onfocus)
- [onformdata](main_module._internal_.SVGFEConvolveMatrixElement.md#onformdata)
- [onfullscreenchange](main_module._internal_.SVGFEConvolveMatrixElement.md#onfullscreenchange)
- [onfullscreenerror](main_module._internal_.SVGFEConvolveMatrixElement.md#onfullscreenerror)
- [ongotpointercapture](main_module._internal_.SVGFEConvolveMatrixElement.md#ongotpointercapture)
- [oninput](main_module._internal_.SVGFEConvolveMatrixElement.md#oninput)
- [oninvalid](main_module._internal_.SVGFEConvolveMatrixElement.md#oninvalid)
- [onkeydown](main_module._internal_.SVGFEConvolveMatrixElement.md#onkeydown)
- [onkeypress](main_module._internal_.SVGFEConvolveMatrixElement.md#onkeypress)
- [onkeyup](main_module._internal_.SVGFEConvolveMatrixElement.md#onkeyup)
- [onload](main_module._internal_.SVGFEConvolveMatrixElement.md#onload)
- [onloadeddata](main_module._internal_.SVGFEConvolveMatrixElement.md#onloadeddata)
- [onloadedmetadata](main_module._internal_.SVGFEConvolveMatrixElement.md#onloadedmetadata)
- [onloadstart](main_module._internal_.SVGFEConvolveMatrixElement.md#onloadstart)
- [onlostpointercapture](main_module._internal_.SVGFEConvolveMatrixElement.md#onlostpointercapture)
- [onmousedown](main_module._internal_.SVGFEConvolveMatrixElement.md#onmousedown)
- [onmouseenter](main_module._internal_.SVGFEConvolveMatrixElement.md#onmouseenter)
- [onmouseleave](main_module._internal_.SVGFEConvolveMatrixElement.md#onmouseleave)
- [onmousemove](main_module._internal_.SVGFEConvolveMatrixElement.md#onmousemove)
- [onmouseout](main_module._internal_.SVGFEConvolveMatrixElement.md#onmouseout)
- [onmouseover](main_module._internal_.SVGFEConvolveMatrixElement.md#onmouseover)
- [onmouseup](main_module._internal_.SVGFEConvolveMatrixElement.md#onmouseup)
- [onpaste](main_module._internal_.SVGFEConvolveMatrixElement.md#onpaste)
- [onpause](main_module._internal_.SVGFEConvolveMatrixElement.md#onpause)
- [onplay](main_module._internal_.SVGFEConvolveMatrixElement.md#onplay)
- [onplaying](main_module._internal_.SVGFEConvolveMatrixElement.md#onplaying)
- [onpointercancel](main_module._internal_.SVGFEConvolveMatrixElement.md#onpointercancel)
- [onpointerdown](main_module._internal_.SVGFEConvolveMatrixElement.md#onpointerdown)
- [onpointerenter](main_module._internal_.SVGFEConvolveMatrixElement.md#onpointerenter)
- [onpointerleave](main_module._internal_.SVGFEConvolveMatrixElement.md#onpointerleave)
- [onpointermove](main_module._internal_.SVGFEConvolveMatrixElement.md#onpointermove)
- [onpointerout](main_module._internal_.SVGFEConvolveMatrixElement.md#onpointerout)
- [onpointerover](main_module._internal_.SVGFEConvolveMatrixElement.md#onpointerover)
- [onpointerup](main_module._internal_.SVGFEConvolveMatrixElement.md#onpointerup)
- [onprogress](main_module._internal_.SVGFEConvolveMatrixElement.md#onprogress)
- [onratechange](main_module._internal_.SVGFEConvolveMatrixElement.md#onratechange)
- [onreset](main_module._internal_.SVGFEConvolveMatrixElement.md#onreset)
- [onresize](main_module._internal_.SVGFEConvolveMatrixElement.md#onresize)
- [onscroll](main_module._internal_.SVGFEConvolveMatrixElement.md#onscroll)
- [onsecuritypolicyviolation](main_module._internal_.SVGFEConvolveMatrixElement.md#onsecuritypolicyviolation)
- [onseeked](main_module._internal_.SVGFEConvolveMatrixElement.md#onseeked)
- [onseeking](main_module._internal_.SVGFEConvolveMatrixElement.md#onseeking)
- [onselect](main_module._internal_.SVGFEConvolveMatrixElement.md#onselect)
- [onselectionchange](main_module._internal_.SVGFEConvolveMatrixElement.md#onselectionchange)
- [onselectstart](main_module._internal_.SVGFEConvolveMatrixElement.md#onselectstart)
- [onslotchange](main_module._internal_.SVGFEConvolveMatrixElement.md#onslotchange)
- [onstalled](main_module._internal_.SVGFEConvolveMatrixElement.md#onstalled)
- [onsubmit](main_module._internal_.SVGFEConvolveMatrixElement.md#onsubmit)
- [onsuspend](main_module._internal_.SVGFEConvolveMatrixElement.md#onsuspend)
- [ontimeupdate](main_module._internal_.SVGFEConvolveMatrixElement.md#ontimeupdate)
- [ontoggle](main_module._internal_.SVGFEConvolveMatrixElement.md#ontoggle)
- [ontouchcancel](main_module._internal_.SVGFEConvolveMatrixElement.md#ontouchcancel)
- [ontouchend](main_module._internal_.SVGFEConvolveMatrixElement.md#ontouchend)
- [ontouchmove](main_module._internal_.SVGFEConvolveMatrixElement.md#ontouchmove)
- [ontouchstart](main_module._internal_.SVGFEConvolveMatrixElement.md#ontouchstart)
- [ontransitioncancel](main_module._internal_.SVGFEConvolveMatrixElement.md#ontransitioncancel)
- [ontransitionend](main_module._internal_.SVGFEConvolveMatrixElement.md#ontransitionend)
- [ontransitionrun](main_module._internal_.SVGFEConvolveMatrixElement.md#ontransitionrun)
- [ontransitionstart](main_module._internal_.SVGFEConvolveMatrixElement.md#ontransitionstart)
- [onvolumechange](main_module._internal_.SVGFEConvolveMatrixElement.md#onvolumechange)
- [onwaiting](main_module._internal_.SVGFEConvolveMatrixElement.md#onwaiting)
- [onwebkitanimationend](main_module._internal_.SVGFEConvolveMatrixElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](main_module._internal_.SVGFEConvolveMatrixElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](main_module._internal_.SVGFEConvolveMatrixElement.md#onwebkitanimationstart)
- [onwebkittransitionend](main_module._internal_.SVGFEConvolveMatrixElement.md#onwebkittransitionend)
- [onwheel](main_module._internal_.SVGFEConvolveMatrixElement.md#onwheel)
- [orderX](main_module._internal_.SVGFEConvolveMatrixElement.md#orderx)
- [orderY](main_module._internal_.SVGFEConvolveMatrixElement.md#ordery)
- [outerHTML](main_module._internal_.SVGFEConvolveMatrixElement.md#outerhtml)
- [ownerDocument](main_module._internal_.SVGFEConvolveMatrixElement.md#ownerdocument)
- [ownerSVGElement](main_module._internal_.SVGFEConvolveMatrixElement.md#ownersvgelement)
- [parentElement](main_module._internal_.SVGFEConvolveMatrixElement.md#parentelement)
- [parentNode](main_module._internal_.SVGFEConvolveMatrixElement.md#parentnode)
- [part](main_module._internal_.SVGFEConvolveMatrixElement.md#part)
- [prefix](main_module._internal_.SVGFEConvolveMatrixElement.md#prefix)
- [preserveAlpha](main_module._internal_.SVGFEConvolveMatrixElement.md#preservealpha)
- [previousElementSibling](main_module._internal_.SVGFEConvolveMatrixElement.md#previouselementsibling)
- [previousSibling](main_module._internal_.SVGFEConvolveMatrixElement.md#previoussibling)
- [result](main_module._internal_.SVGFEConvolveMatrixElement.md#result)
- [scrollHeight](main_module._internal_.SVGFEConvolveMatrixElement.md#scrollheight)
- [scrollLeft](main_module._internal_.SVGFEConvolveMatrixElement.md#scrollleft)
- [scrollTop](main_module._internal_.SVGFEConvolveMatrixElement.md#scrolltop)
- [scrollWidth](main_module._internal_.SVGFEConvolveMatrixElement.md#scrollwidth)
- [shadowRoot](main_module._internal_.SVGFEConvolveMatrixElement.md#shadowroot)
- [slot](main_module._internal_.SVGFEConvolveMatrixElement.md#slot)
- [style](main_module._internal_.SVGFEConvolveMatrixElement.md#style)
- [tabIndex](main_module._internal_.SVGFEConvolveMatrixElement.md#tabindex)
- [tagName](main_module._internal_.SVGFEConvolveMatrixElement.md#tagname)
- [targetX](main_module._internal_.SVGFEConvolveMatrixElement.md#targetx)
- [targetY](main_module._internal_.SVGFEConvolveMatrixElement.md#targety)
- [textContent](main_module._internal_.SVGFEConvolveMatrixElement.md#textcontent)
- [viewportElement](main_module._internal_.SVGFEConvolveMatrixElement.md#viewportelement)
- [width](main_module._internal_.SVGFEConvolveMatrixElement.md#width)
- [x](main_module._internal_.SVGFEConvolveMatrixElement.md#x)
- [y](main_module._internal_.SVGFEConvolveMatrixElement.md#y)

### Methods

- [addEventListener](main_module._internal_.SVGFEConvolveMatrixElement.md#addeventlistener)
- [after](main_module._internal_.SVGFEConvolveMatrixElement.md#after)
- [animate](main_module._internal_.SVGFEConvolveMatrixElement.md#animate)
- [append](main_module._internal_.SVGFEConvolveMatrixElement.md#append)
- [appendChild](main_module._internal_.SVGFEConvolveMatrixElement.md#appendchild)
- [attachShadow](main_module._internal_.SVGFEConvolveMatrixElement.md#attachshadow)
- [before](main_module._internal_.SVGFEConvolveMatrixElement.md#before)
- [blur](main_module._internal_.SVGFEConvolveMatrixElement.md#blur)
- [cloneNode](main_module._internal_.SVGFEConvolveMatrixElement.md#clonenode)
- [closest](main_module._internal_.SVGFEConvolveMatrixElement.md#closest)
- [compareDocumentPosition](main_module._internal_.SVGFEConvolveMatrixElement.md#comparedocumentposition)
- [contains](main_module._internal_.SVGFEConvolveMatrixElement.md#contains)
- [dispatchEvent](main_module._internal_.SVGFEConvolveMatrixElement.md#dispatchevent)
- [focus](main_module._internal_.SVGFEConvolveMatrixElement.md#focus)
- [getAnimations](main_module._internal_.SVGFEConvolveMatrixElement.md#getanimations)
- [getAttribute](main_module._internal_.SVGFEConvolveMatrixElement.md#getattribute)
- [getAttributeNS](main_module._internal_.SVGFEConvolveMatrixElement.md#getattributens)
- [getAttributeNames](main_module._internal_.SVGFEConvolveMatrixElement.md#getattributenames)
- [getAttributeNode](main_module._internal_.SVGFEConvolveMatrixElement.md#getattributenode)
- [getAttributeNodeNS](main_module._internal_.SVGFEConvolveMatrixElement.md#getattributenodens)
- [getBoundingClientRect](main_module._internal_.SVGFEConvolveMatrixElement.md#getboundingclientrect)
- [getClientRects](main_module._internal_.SVGFEConvolveMatrixElement.md#getclientrects)
- [getElementsByClassName](main_module._internal_.SVGFEConvolveMatrixElement.md#getelementsbyclassname)
- [getElementsByTagName](main_module._internal_.SVGFEConvolveMatrixElement.md#getelementsbytagname)
- [getElementsByTagNameNS](main_module._internal_.SVGFEConvolveMatrixElement.md#getelementsbytagnamens)
- [getRootNode](main_module._internal_.SVGFEConvolveMatrixElement.md#getrootnode)
- [hasAttribute](main_module._internal_.SVGFEConvolveMatrixElement.md#hasattribute)
- [hasAttributeNS](main_module._internal_.SVGFEConvolveMatrixElement.md#hasattributens)
- [hasAttributes](main_module._internal_.SVGFEConvolveMatrixElement.md#hasattributes)
- [hasChildNodes](main_module._internal_.SVGFEConvolveMatrixElement.md#haschildnodes)
- [hasPointerCapture](main_module._internal_.SVGFEConvolveMatrixElement.md#haspointercapture)
- [insertAdjacentElement](main_module._internal_.SVGFEConvolveMatrixElement.md#insertadjacentelement)
- [insertAdjacentHTML](main_module._internal_.SVGFEConvolveMatrixElement.md#insertadjacenthtml)
- [insertAdjacentText](main_module._internal_.SVGFEConvolveMatrixElement.md#insertadjacenttext)
- [insertBefore](main_module._internal_.SVGFEConvolveMatrixElement.md#insertbefore)
- [isDefaultNamespace](main_module._internal_.SVGFEConvolveMatrixElement.md#isdefaultnamespace)
- [isEqualNode](main_module._internal_.SVGFEConvolveMatrixElement.md#isequalnode)
- [isSameNode](main_module._internal_.SVGFEConvolveMatrixElement.md#issamenode)
- [lookupNamespaceURI](main_module._internal_.SVGFEConvolveMatrixElement.md#lookupnamespaceuri)
- [lookupPrefix](main_module._internal_.SVGFEConvolveMatrixElement.md#lookupprefix)
- [matches](main_module._internal_.SVGFEConvolveMatrixElement.md#matches)
- [normalize](main_module._internal_.SVGFEConvolveMatrixElement.md#normalize)
- [prepend](main_module._internal_.SVGFEConvolveMatrixElement.md#prepend)
- [querySelector](main_module._internal_.SVGFEConvolveMatrixElement.md#queryselector)
- [querySelectorAll](main_module._internal_.SVGFEConvolveMatrixElement.md#queryselectorall)
- [releasePointerCapture](main_module._internal_.SVGFEConvolveMatrixElement.md#releasepointercapture)
- [remove](main_module._internal_.SVGFEConvolveMatrixElement.md#remove)
- [removeAttribute](main_module._internal_.SVGFEConvolveMatrixElement.md#removeattribute)
- [removeAttributeNS](main_module._internal_.SVGFEConvolveMatrixElement.md#removeattributens)
- [removeAttributeNode](main_module._internal_.SVGFEConvolveMatrixElement.md#removeattributenode)
- [removeChild](main_module._internal_.SVGFEConvolveMatrixElement.md#removechild)
- [removeEventListener](main_module._internal_.SVGFEConvolveMatrixElement.md#removeeventlistener)
- [replaceChild](main_module._internal_.SVGFEConvolveMatrixElement.md#replacechild)
- [replaceChildren](main_module._internal_.SVGFEConvolveMatrixElement.md#replacechildren)
- [replaceWith](main_module._internal_.SVGFEConvolveMatrixElement.md#replacewith)
- [requestFullscreen](main_module._internal_.SVGFEConvolveMatrixElement.md#requestfullscreen)
- [requestPointerLock](main_module._internal_.SVGFEConvolveMatrixElement.md#requestpointerlock)
- [scroll](main_module._internal_.SVGFEConvolveMatrixElement.md#scroll)
- [scrollBy](main_module._internal_.SVGFEConvolveMatrixElement.md#scrollby)
- [scrollIntoView](main_module._internal_.SVGFEConvolveMatrixElement.md#scrollintoview)
- [scrollTo](main_module._internal_.SVGFEConvolveMatrixElement.md#scrollto)
- [setAttribute](main_module._internal_.SVGFEConvolveMatrixElement.md#setattribute)
- [setAttributeNS](main_module._internal_.SVGFEConvolveMatrixElement.md#setattributens)
- [setAttributeNode](main_module._internal_.SVGFEConvolveMatrixElement.md#setattributenode)
- [setAttributeNodeNS](main_module._internal_.SVGFEConvolveMatrixElement.md#setattributenodens)
- [setPointerCapture](main_module._internal_.SVGFEConvolveMatrixElement.md#setpointercapture)
- [toggleAttribute](main_module._internal_.SVGFEConvolveMatrixElement.md#toggleattribute)
- [webkitMatchesSelector](main_module._internal_.SVGFEConvolveMatrixElement.md#webkitmatchesselector)
...
• `Readonly` **bias**: [`SVGAnimatedNumber`](../modules/main_module._internal_.md#svganimatednumber)
...
• `Readonly` **divisor**: [`SVGAnimatedNumber`](../modules/main_module._internal_.md#svganimatednumber)
...
• `Readonly` **edgeMode**: [`SVGAnimatedEnumeration`](../modules/main_module._internal_.md#svganimatedenumeration)
...
[SVGFilterPrimitiveStandardAttributes](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md).[height](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md#height)
...
• `Readonly` **in1**: [`SVGAnimatedString`](../modules/main_module._internal_.md#svganimatedstring)
...
• `Readonly` **kernelMatrix**: [`SVGAnimatedNumberList`](../modules/main_module._internal_.md#svganimatednumberlist)
...
• `Readonly` **kernelUnitLengthX**: [`SVGAnimatedNumber`](../modules/main_module._internal_.md#svganimatednumber)
...
• `Readonly` **kernelUnitLengthY**: [`SVGAnimatedNumber`](../modules/main_module._internal_.md#svganimatednumber)
...
• `Readonly` **orderX**: [`SVGAnimatedInteger`](../modules/main_module._internal_.md#svganimatedinteger)
...
• `Readonly` **orderY**: [`SVGAnimatedInteger`](../modules/main_module._internal_.md#svganimatedinteger)
...
• `Readonly` **preserveAlpha**: [`SVGAnimatedBoolean`](../modules/main_module._internal_.md#svganimatedboolean)
...
[SVGFilterPrimitiveStandardAttributes](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md).[result](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md#result)
...
• `Readonly` **targetX**: [`SVGAnimatedInteger`](../modules/main_module._internal_.md#svganimatedinteger)
...
• `Readonly` **targetY**: [`SVGAnimatedInteger`](../modules/main_module._internal_.md#svganimatedinteger)
...
[SVGFilterPrimitiveStandardAttributes](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md).[width](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md#width)
...
[SVGFilterPrimitiveStandardAttributes](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md).[x](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md#x)
...
[SVGFilterPrimitiveStandardAttributes](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md).[y](main_module._internal_.SVGFilterPrimitiveStandardAttributes.md#y)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGFEConvolveMatrixElement`](../modules/main_module._internal_.md#svgfeconvolvematrixelement), `ev`: [`SVGElementEventMap`](main_module._internal_.SVGElementEventMap.md)[`K`]) => `any` |
