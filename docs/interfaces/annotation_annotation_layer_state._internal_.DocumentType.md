[neuroglancer](../README.md) / [Modules](../modules.md) / [annotation/annotation\_layer\_state](../modules/annotation_annotation_layer_state.md) / [<internal\>](../modules/annotation_annotation_layer_state._internal_.md) / DocumentType

# Interface: DocumentType

[annotation/annotation_layer_state](../modules/annotation_annotation_layer_state.md).[<internal>](../modules/annotation_annotation_layer_state._internal_.md).DocumentType
...
- [ATTRIBUTE\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#attribute_node)
- [CDATA\_SECTION\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#cdata_section_node)
- [COMMENT\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#document_fragment_node)
- [DOCUMENT\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](annotation_annotation_layer_state._internal_.DocumentType.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](annotation_annotation_layer_state._internal_.DocumentType.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](annotation_annotation_layer_state._internal_.DocumentType.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](annotation_annotation_layer_state._internal_.DocumentType.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](annotation_annotation_layer_state._internal_.DocumentType.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](annotation_annotation_layer_state._internal_.DocumentType.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#document_type_node)
- [ELEMENT\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#element_node)
- [ENTITY\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#entity_reference_node)
- [NOTATION\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#processing_instruction_node)
- [TEXT\_NODE](annotation_annotation_layer_state._internal_.DocumentType.md#text_node)
- [baseURI](annotation_annotation_layer_state._internal_.DocumentType.md#baseuri)
- [childNodes](annotation_annotation_layer_state._internal_.DocumentType.md#childnodes)
- [firstChild](annotation_annotation_layer_state._internal_.DocumentType.md#firstchild)
- [isConnected](annotation_annotation_layer_state._internal_.DocumentType.md#isconnected)
- [lastChild](annotation_annotation_layer_state._internal_.DocumentType.md#lastchild)
- [name](annotation_annotation_layer_state._internal_.DocumentType.md#name)
- [nextSibling](annotation_annotation_layer_state._internal_.DocumentType.md#nextsibling)
- [nodeName](annotation_annotation_layer_state._internal_.DocumentType.md#nodename)
- [nodeType](annotation_annotation_layer_state._internal_.DocumentType.md#nodetype)
- [nodeValue](annotation_annotation_layer_state._internal_.DocumentType.md#nodevalue)
- [ownerDocument](annotation_annotation_layer_state._internal_.DocumentType.md#ownerdocument)
- [parentElement](annotation_annotation_layer_state._internal_.DocumentType.md#parentelement)
- [parentNode](annotation_annotation_layer_state._internal_.DocumentType.md#parentnode)
- [previousSibling](annotation_annotation_layer_state._internal_.DocumentType.md#previoussibling)
- [publicId](annotation_annotation_layer_state._internal_.DocumentType.md#publicid)
- [systemId](annotation_annotation_layer_state._internal_.DocumentType.md#systemid)
- [textContent](annotation_annotation_layer_state._internal_.DocumentType.md#textcontent)

### Methods

- [addEventListener](annotation_annotation_layer_state._internal_.DocumentType.md#addeventlistener)
- [after](annotation_annotation_layer_state._internal_.DocumentType.md#after)
- [appendChild](annotation_annotation_layer_state._internal_.DocumentType.md#appendchild)
- [before](annotation_annotation_layer_state._internal_.DocumentType.md#before)
- [cloneNode](annotation_annotation_layer_state._internal_.DocumentType.md#clonenode)
- [compareDocumentPosition](annotation_annotation_layer_state._internal_.DocumentType.md#comparedocumentposition)
- [contains](annotation_annotation_layer_state._internal_.DocumentType.md#contains)
- [dispatchEvent](annotation_annotation_layer_state._internal_.DocumentType.md#dispatchevent)
- [getRootNode](annotation_annotation_layer_state._internal_.DocumentType.md#getrootnode)
- [hasChildNodes](annotation_annotation_layer_state._internal_.DocumentType.md#haschildnodes)
- [insertBefore](annotation_annotation_layer_state._internal_.DocumentType.md#insertbefore)
- [isDefaultNamespace](annotation_annotation_layer_state._internal_.DocumentType.md#isdefaultnamespace)
- [isEqualNode](annotation_annotation_layer_state._internal_.DocumentType.md#isequalnode)
- [isSameNode](annotation_annotation_layer_state._internal_.DocumentType.md#issamenode)
- [lookupNamespaceURI](annotation_annotation_layer_state._internal_.DocumentType.md#lookupnamespaceuri)
- [lookupPrefix](annotation_annotation_layer_state._internal_.DocumentType.md#lookupprefix)
- [normalize](annotation_annotation_layer_state._internal_.DocumentType.md#normalize)
- [remove](annotation_annotation_layer_state._internal_.DocumentType.md#remove)
- [removeChild](annotation_annotation_layer_state._internal_.DocumentType.md#removechild)
- [removeEventListener](annotation_annotation_layer_state._internal_.DocumentType.md#removeeventlistener)
- [replaceChild](annotation_annotation_layer_state._internal_.DocumentType.md#replacechild)
- [replaceWith](annotation_annotation_layer_state._internal_.DocumentType.md#replacewith)
...
[ChildNode](annotation_annotation_layer_state._internal_.ChildNode.md).[DOCUMENT_FRAGMENT_NODE](annotation_annotation_layer_state._internal_.ChildNode.md#document_fragment_node)
...
[ChildNode](annotation_annotation_layer_state._internal_.ChildNode.md).[TEXT_NODE](annotation_annotation_layer_state._internal_.ChildNode.md#text_node)
