[neuroglancer](../README.md) / [Modules](../modules.md) / [axes\_lines](../modules/axes_lines.md) / [<internal\>](../modules/axes_lines._internal_.md) / CharacterData

# Interface: CharacterData

[axes_lines](../modules/axes_lines.md).[<internal>](../modules/axes_lines._internal_.md).CharacterData
...
- [ATTRIBUTE\_NODE](axes_lines._internal_.CharacterData.md#attribute_node)
- [CDATA\_SECTION\_NODE](axes_lines._internal_.CharacterData.md#cdata_section_node)
- [COMMENT\_NODE](axes_lines._internal_.CharacterData.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](axes_lines._internal_.CharacterData.md#document_fragment_node)
- [DOCUMENT\_NODE](axes_lines._internal_.CharacterData.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](axes_lines._internal_.CharacterData.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](axes_lines._internal_.CharacterData.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](axes_lines._internal_.CharacterData.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](axes_lines._internal_.CharacterData.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](axes_lines._internal_.CharacterData.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](axes_lines._internal_.CharacterData.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](axes_lines._internal_.CharacterData.md#document_type_node)
- [ELEMENT\_NODE](axes_lines._internal_.CharacterData.md#element_node)
- [ENTITY\_NODE](axes_lines._internal_.CharacterData.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](axes_lines._internal_.CharacterData.md#entity_reference_node)
- [NOTATION\_NODE](axes_lines._internal_.CharacterData.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](axes_lines._internal_.CharacterData.md#processing_instruction_node)
- [TEXT\_NODE](axes_lines._internal_.CharacterData.md#text_node)
- [baseURI](axes_lines._internal_.CharacterData.md#baseuri)
- [childNodes](axes_lines._internal_.CharacterData.md#childnodes)
- [data](axes_lines._internal_.CharacterData.md#data)
- [firstChild](axes_lines._internal_.CharacterData.md#firstchild)
- [isConnected](axes_lines._internal_.CharacterData.md#isconnected)
- [lastChild](axes_lines._internal_.CharacterData.md#lastchild)
- [length](axes_lines._internal_.CharacterData.md#length)
- [nextElementSibling](axes_lines._internal_.CharacterData.md#nextelementsibling)
- [nextSibling](axes_lines._internal_.CharacterData.md#nextsibling)
- [nodeName](axes_lines._internal_.CharacterData.md#nodename)
- [nodeType](axes_lines._internal_.CharacterData.md#nodetype)
- [nodeValue](axes_lines._internal_.CharacterData.md#nodevalue)
- [ownerDocument](axes_lines._internal_.CharacterData.md#ownerdocument)
- [parentElement](axes_lines._internal_.CharacterData.md#parentelement)
- [parentNode](axes_lines._internal_.CharacterData.md#parentnode)
- [previousElementSibling](axes_lines._internal_.CharacterData.md#previouselementsibling)
- [previousSibling](axes_lines._internal_.CharacterData.md#previoussibling)
- [textContent](axes_lines._internal_.CharacterData.md#textcontent)

### Methods

- [addEventListener](axes_lines._internal_.CharacterData.md#addeventlistener)
- [after](axes_lines._internal_.CharacterData.md#after)
- [appendChild](axes_lines._internal_.CharacterData.md#appendchild)
- [appendData](axes_lines._internal_.CharacterData.md#appenddata)
- [before](axes_lines._internal_.CharacterData.md#before)
- [cloneNode](axes_lines._internal_.CharacterData.md#clonenode)
- [compareDocumentPosition](axes_lines._internal_.CharacterData.md#comparedocumentposition)
- [contains](axes_lines._internal_.CharacterData.md#contains)
- [deleteData](axes_lines._internal_.CharacterData.md#deletedata)
- [dispatchEvent](axes_lines._internal_.CharacterData.md#dispatchevent)
- [getRootNode](axes_lines._internal_.CharacterData.md#getrootnode)
- [hasChildNodes](axes_lines._internal_.CharacterData.md#haschildnodes)
- [insertBefore](axes_lines._internal_.CharacterData.md#insertbefore)
- [insertData](axes_lines._internal_.CharacterData.md#insertdata)
- [isDefaultNamespace](axes_lines._internal_.CharacterData.md#isdefaultnamespace)
- [isEqualNode](axes_lines._internal_.CharacterData.md#isequalnode)
- [isSameNode](axes_lines._internal_.CharacterData.md#issamenode)
- [lookupNamespaceURI](axes_lines._internal_.CharacterData.md#lookupnamespaceuri)
- [lookupPrefix](axes_lines._internal_.CharacterData.md#lookupprefix)
- [normalize](axes_lines._internal_.CharacterData.md#normalize)
- [remove](axes_lines._internal_.CharacterData.md#remove)
- [removeChild](axes_lines._internal_.CharacterData.md#removechild)
- [removeEventListener](axes_lines._internal_.CharacterData.md#removeeventlistener)
- [replaceChild](axes_lines._internal_.CharacterData.md#replacechild)
- [replaceData](axes_lines._internal_.CharacterData.md#replacedata)
- [replaceWith](axes_lines._internal_.CharacterData.md#replacewith)
- [substringData](axes_lines._internal_.CharacterData.md#substringdata)
...
[ChildNode](axes_lines._internal_.ChildNode.md).[nodeType](axes_lines._internal_.ChildNode.md#nodetype)
...
[ChildNode](axes_lines._internal_.ChildNode.md).[addEventListener](axes_lines._internal_.ChildNode.md#addeventlistener)
...
[ChildNode](axes_lines._internal_.ChildNode.md).[contains](axes_lines._internal_.ChildNode.md#contains)
