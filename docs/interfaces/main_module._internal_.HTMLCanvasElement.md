[neuroglancer](../README.md) / [Exports](../modules.md) / [main\_module](../modules/main_module.md) / [<internal\>](../modules/main_module._internal_.md) / HTMLCanvasElement

# Interface: HTMLCanvasElement

[main_module](../modules/main_module.md).[<internal>](../modules/main_module._internal_.md).HTMLCanvasElement
...
- [ATTRIBUTE\_NODE](main_module._internal_.HTMLCanvasElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](main_module._internal_.HTMLCanvasElement.md#cdata_section_node)
- [COMMENT\_NODE](main_module._internal_.HTMLCanvasElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](main_module._internal_.HTMLCanvasElement.md#document_fragment_node)
- [DOCUMENT\_NODE](main_module._internal_.HTMLCanvasElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](main_module._internal_.HTMLCanvasElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](main_module._internal_.HTMLCanvasElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](main_module._internal_.HTMLCanvasElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](main_module._internal_.HTMLCanvasElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](main_module._internal_.HTMLCanvasElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](main_module._internal_.HTMLCanvasElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](main_module._internal_.HTMLCanvasElement.md#document_type_node)
- [ELEMENT\_NODE](main_module._internal_.HTMLCanvasElement.md#element_node)
- [ENTITY\_NODE](main_module._internal_.HTMLCanvasElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](main_module._internal_.HTMLCanvasElement.md#entity_reference_node)
- [NOTATION\_NODE](main_module._internal_.HTMLCanvasElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](main_module._internal_.HTMLCanvasElement.md#processing_instruction_node)
- [TEXT\_NODE](main_module._internal_.HTMLCanvasElement.md#text_node)
- [accessKey](main_module._internal_.HTMLCanvasElement.md#accesskey)
- [accessKeyLabel](main_module._internal_.HTMLCanvasElement.md#accesskeylabel)
- [ariaAtomic](main_module._internal_.HTMLCanvasElement.md#ariaatomic)
- [ariaAutoComplete](main_module._internal_.HTMLCanvasElement.md#ariaautocomplete)
- [ariaBusy](main_module._internal_.HTMLCanvasElement.md#ariabusy)
- [ariaChecked](main_module._internal_.HTMLCanvasElement.md#ariachecked)
- [ariaColCount](main_module._internal_.HTMLCanvasElement.md#ariacolcount)
- [ariaColIndex](main_module._internal_.HTMLCanvasElement.md#ariacolindex)
- [ariaColSpan](main_module._internal_.HTMLCanvasElement.md#ariacolspan)
- [ariaCurrent](main_module._internal_.HTMLCanvasElement.md#ariacurrent)
- [ariaDisabled](main_module._internal_.HTMLCanvasElement.md#ariadisabled)
- [ariaExpanded](main_module._internal_.HTMLCanvasElement.md#ariaexpanded)
- [ariaHasPopup](main_module._internal_.HTMLCanvasElement.md#ariahaspopup)
- [ariaHidden](main_module._internal_.HTMLCanvasElement.md#ariahidden)
- [ariaKeyShortcuts](main_module._internal_.HTMLCanvasElement.md#ariakeyshortcuts)
- [ariaLabel](main_module._internal_.HTMLCanvasElement.md#arialabel)
- [ariaLevel](main_module._internal_.HTMLCanvasElement.md#arialevel)
- [ariaLive](main_module._internal_.HTMLCanvasElement.md#arialive)
- [ariaModal](main_module._internal_.HTMLCanvasElement.md#ariamodal)
- [ariaMultiLine](main_module._internal_.HTMLCanvasElement.md#ariamultiline)
- [ariaMultiSelectable](main_module._internal_.HTMLCanvasElement.md#ariamultiselectable)
- [ariaOrientation](main_module._internal_.HTMLCanvasElement.md#ariaorientation)
- [ariaPlaceholder](main_module._internal_.HTMLCanvasElement.md#ariaplaceholder)
- [ariaPosInSet](main_module._internal_.HTMLCanvasElement.md#ariaposinset)
- [ariaPressed](main_module._internal_.HTMLCanvasElement.md#ariapressed)
- [ariaReadOnly](main_module._internal_.HTMLCanvasElement.md#ariareadonly)
- [ariaRequired](main_module._internal_.HTMLCanvasElement.md#ariarequired)
- [ariaRoleDescription](main_module._internal_.HTMLCanvasElement.md#ariaroledescription)
- [ariaRowCount](main_module._internal_.HTMLCanvasElement.md#ariarowcount)
- [ariaRowIndex](main_module._internal_.HTMLCanvasElement.md#ariarowindex)
- [ariaRowSpan](main_module._internal_.HTMLCanvasElement.md#ariarowspan)
- [ariaSelected](main_module._internal_.HTMLCanvasElement.md#ariaselected)
- [ariaSetSize](main_module._internal_.HTMLCanvasElement.md#ariasetsize)
- [ariaSort](main_module._internal_.HTMLCanvasElement.md#ariasort)
- [ariaValueMax](main_module._internal_.HTMLCanvasElement.md#ariavaluemax)
- [ariaValueMin](main_module._internal_.HTMLCanvasElement.md#ariavaluemin)
- [ariaValueNow](main_module._internal_.HTMLCanvasElement.md#ariavaluenow)
- [ariaValueText](main_module._internal_.HTMLCanvasElement.md#ariavaluetext)
- [assignedSlot](main_module._internal_.HTMLCanvasElement.md#assignedslot)
- [attributes](main_module._internal_.HTMLCanvasElement.md#attributes)
- [autocapitalize](main_module._internal_.HTMLCanvasElement.md#autocapitalize)
- [autofocus](main_module._internal_.HTMLCanvasElement.md#autofocus)
- [baseURI](main_module._internal_.HTMLCanvasElement.md#baseuri)
- [childElementCount](main_module._internal_.HTMLCanvasElement.md#childelementcount)
- [childNodes](main_module._internal_.HTMLCanvasElement.md#childnodes)
- [children](main_module._internal_.HTMLCanvasElement.md#children)
- [classList](main_module._internal_.HTMLCanvasElement.md#classlist)
- [className](main_module._internal_.HTMLCanvasElement.md#classname)
- [clientHeight](main_module._internal_.HTMLCanvasElement.md#clientheight)
- [clientLeft](main_module._internal_.HTMLCanvasElement.md#clientleft)
- [clientTop](main_module._internal_.HTMLCanvasElement.md#clienttop)
- [clientWidth](main_module._internal_.HTMLCanvasElement.md#clientwidth)
- [contentEditable](main_module._internal_.HTMLCanvasElement.md#contenteditable)
- [dataset](main_module._internal_.HTMLCanvasElement.md#dataset)
- [dir](main_module._internal_.HTMLCanvasElement.md#dir)
- [draggable](main_module._internal_.HTMLCanvasElement.md#draggable)
- [enterKeyHint](main_module._internal_.HTMLCanvasElement.md#enterkeyhint)
- [firstChild](main_module._internal_.HTMLCanvasElement.md#firstchild)
- [firstElementChild](main_module._internal_.HTMLCanvasElement.md#firstelementchild)
- [height](main_module._internal_.HTMLCanvasElement.md#height)
- [hidden](main_module._internal_.HTMLCanvasElement.md#hidden)
- [id](main_module._internal_.HTMLCanvasElement.md#id)
- [innerHTML](main_module._internal_.HTMLCanvasElement.md#innerhtml)
- [innerText](main_module._internal_.HTMLCanvasElement.md#innertext)
- [inputMode](main_module._internal_.HTMLCanvasElement.md#inputmode)
- [isConnected](main_module._internal_.HTMLCanvasElement.md#isconnected)
- [isContentEditable](main_module._internal_.HTMLCanvasElement.md#iscontenteditable)
- [lang](main_module._internal_.HTMLCanvasElement.md#lang)
- [lastChild](main_module._internal_.HTMLCanvasElement.md#lastchild)
- [lastElementChild](main_module._internal_.HTMLCanvasElement.md#lastelementchild)
- [localName](main_module._internal_.HTMLCanvasElement.md#localname)
- [namespaceURI](main_module._internal_.HTMLCanvasElement.md#namespaceuri)
- [nextElementSibling](main_module._internal_.HTMLCanvasElement.md#nextelementsibling)
- [nextSibling](main_module._internal_.HTMLCanvasElement.md#nextsibling)
- [nodeName](main_module._internal_.HTMLCanvasElement.md#nodename)
- [nodeType](main_module._internal_.HTMLCanvasElement.md#nodetype)
- [nodeValue](main_module._internal_.HTMLCanvasElement.md#nodevalue)
- [nonce](main_module._internal_.HTMLCanvasElement.md#nonce)
- [offsetHeight](main_module._internal_.HTMLCanvasElement.md#offsetheight)
- [offsetLeft](main_module._internal_.HTMLCanvasElement.md#offsetleft)
- [offsetParent](main_module._internal_.HTMLCanvasElement.md#offsetparent)
- [offsetTop](main_module._internal_.HTMLCanvasElement.md#offsettop)
- [offsetWidth](main_module._internal_.HTMLCanvasElement.md#offsetwidth)
- [onabort](main_module._internal_.HTMLCanvasElement.md#onabort)
- [onanimationcancel](main_module._internal_.HTMLCanvasElement.md#onanimationcancel)
- [onanimationend](main_module._internal_.HTMLCanvasElement.md#onanimationend)
- [onanimationiteration](main_module._internal_.HTMLCanvasElement.md#onanimationiteration)
- [onanimationstart](main_module._internal_.HTMLCanvasElement.md#onanimationstart)
- [onauxclick](main_module._internal_.HTMLCanvasElement.md#onauxclick)
- [onblur](main_module._internal_.HTMLCanvasElement.md#onblur)
- [oncanplay](main_module._internal_.HTMLCanvasElement.md#oncanplay)
- [oncanplaythrough](main_module._internal_.HTMLCanvasElement.md#oncanplaythrough)
- [onchange](main_module._internal_.HTMLCanvasElement.md#onchange)
- [onclick](main_module._internal_.HTMLCanvasElement.md#onclick)
- [onclose](main_module._internal_.HTMLCanvasElement.md#onclose)
- [oncontextmenu](main_module._internal_.HTMLCanvasElement.md#oncontextmenu)
- [oncopy](main_module._internal_.HTMLCanvasElement.md#oncopy)
- [oncuechange](main_module._internal_.HTMLCanvasElement.md#oncuechange)
- [oncut](main_module._internal_.HTMLCanvasElement.md#oncut)
- [ondblclick](main_module._internal_.HTMLCanvasElement.md#ondblclick)
- [ondrag](main_module._internal_.HTMLCanvasElement.md#ondrag)
- [ondragend](main_module._internal_.HTMLCanvasElement.md#ondragend)
- [ondragenter](main_module._internal_.HTMLCanvasElement.md#ondragenter)
- [ondragleave](main_module._internal_.HTMLCanvasElement.md#ondragleave)
- [ondragover](main_module._internal_.HTMLCanvasElement.md#ondragover)
- [ondragstart](main_module._internal_.HTMLCanvasElement.md#ondragstart)
- [ondrop](main_module._internal_.HTMLCanvasElement.md#ondrop)
- [ondurationchange](main_module._internal_.HTMLCanvasElement.md#ondurationchange)
- [onemptied](main_module._internal_.HTMLCanvasElement.md#onemptied)
- [onended](main_module._internal_.HTMLCanvasElement.md#onended)
- [onerror](main_module._internal_.HTMLCanvasElement.md#onerror)
- [onfocus](main_module._internal_.HTMLCanvasElement.md#onfocus)
- [onformdata](main_module._internal_.HTMLCanvasElement.md#onformdata)
- [onfullscreenchange](main_module._internal_.HTMLCanvasElement.md#onfullscreenchange)
- [onfullscreenerror](main_module._internal_.HTMLCanvasElement.md#onfullscreenerror)
- [ongotpointercapture](main_module._internal_.HTMLCanvasElement.md#ongotpointercapture)
- [oninput](main_module._internal_.HTMLCanvasElement.md#oninput)
- [oninvalid](main_module._internal_.HTMLCanvasElement.md#oninvalid)
- [onkeydown](main_module._internal_.HTMLCanvasElement.md#onkeydown)
- [onkeypress](main_module._internal_.HTMLCanvasElement.md#onkeypress)
- [onkeyup](main_module._internal_.HTMLCanvasElement.md#onkeyup)
- [onload](main_module._internal_.HTMLCanvasElement.md#onload)
- [onloadeddata](main_module._internal_.HTMLCanvasElement.md#onloadeddata)
- [onloadedmetadata](main_module._internal_.HTMLCanvasElement.md#onloadedmetadata)
- [onloadstart](main_module._internal_.HTMLCanvasElement.md#onloadstart)
- [onlostpointercapture](main_module._internal_.HTMLCanvasElement.md#onlostpointercapture)
- [onmousedown](main_module._internal_.HTMLCanvasElement.md#onmousedown)
- [onmouseenter](main_module._internal_.HTMLCanvasElement.md#onmouseenter)
- [onmouseleave](main_module._internal_.HTMLCanvasElement.md#onmouseleave)
- [onmousemove](main_module._internal_.HTMLCanvasElement.md#onmousemove)
- [onmouseout](main_module._internal_.HTMLCanvasElement.md#onmouseout)
- [onmouseover](main_module._internal_.HTMLCanvasElement.md#onmouseover)
- [onmouseup](main_module._internal_.HTMLCanvasElement.md#onmouseup)
- [onpaste](main_module._internal_.HTMLCanvasElement.md#onpaste)
- [onpause](main_module._internal_.HTMLCanvasElement.md#onpause)
- [onplay](main_module._internal_.HTMLCanvasElement.md#onplay)
- [onplaying](main_module._internal_.HTMLCanvasElement.md#onplaying)
- [onpointercancel](main_module._internal_.HTMLCanvasElement.md#onpointercancel)
- [onpointerdown](main_module._internal_.HTMLCanvasElement.md#onpointerdown)
- [onpointerenter](main_module._internal_.HTMLCanvasElement.md#onpointerenter)
- [onpointerleave](main_module._internal_.HTMLCanvasElement.md#onpointerleave)
- [onpointermove](main_module._internal_.HTMLCanvasElement.md#onpointermove)
- [onpointerout](main_module._internal_.HTMLCanvasElement.md#onpointerout)
- [onpointerover](main_module._internal_.HTMLCanvasElement.md#onpointerover)
- [onpointerup](main_module._internal_.HTMLCanvasElement.md#onpointerup)
- [onprogress](main_module._internal_.HTMLCanvasElement.md#onprogress)
- [onratechange](main_module._internal_.HTMLCanvasElement.md#onratechange)
- [onreset](main_module._internal_.HTMLCanvasElement.md#onreset)
- [onresize](main_module._internal_.HTMLCanvasElement.md#onresize)
- [onscroll](main_module._internal_.HTMLCanvasElement.md#onscroll)
- [onsecuritypolicyviolation](main_module._internal_.HTMLCanvasElement.md#onsecuritypolicyviolation)
- [onseeked](main_module._internal_.HTMLCanvasElement.md#onseeked)
- [onseeking](main_module._internal_.HTMLCanvasElement.md#onseeking)
- [onselect](main_module._internal_.HTMLCanvasElement.md#onselect)
- [onselectionchange](main_module._internal_.HTMLCanvasElement.md#onselectionchange)
- [onselectstart](main_module._internal_.HTMLCanvasElement.md#onselectstart)
- [onslotchange](main_module._internal_.HTMLCanvasElement.md#onslotchange)
- [onstalled](main_module._internal_.HTMLCanvasElement.md#onstalled)
- [onsubmit](main_module._internal_.HTMLCanvasElement.md#onsubmit)
- [onsuspend](main_module._internal_.HTMLCanvasElement.md#onsuspend)
- [ontimeupdate](main_module._internal_.HTMLCanvasElement.md#ontimeupdate)
- [ontoggle](main_module._internal_.HTMLCanvasElement.md#ontoggle)
- [ontouchcancel](main_module._internal_.HTMLCanvasElement.md#ontouchcancel)
- [ontouchend](main_module._internal_.HTMLCanvasElement.md#ontouchend)
- [ontouchmove](main_module._internal_.HTMLCanvasElement.md#ontouchmove)
- [ontouchstart](main_module._internal_.HTMLCanvasElement.md#ontouchstart)
- [ontransitioncancel](main_module._internal_.HTMLCanvasElement.md#ontransitioncancel)
- [ontransitionend](main_module._internal_.HTMLCanvasElement.md#ontransitionend)
- [ontransitionrun](main_module._internal_.HTMLCanvasElement.md#ontransitionrun)
- [ontransitionstart](main_module._internal_.HTMLCanvasElement.md#ontransitionstart)
- [onvolumechange](main_module._internal_.HTMLCanvasElement.md#onvolumechange)
- [onwaiting](main_module._internal_.HTMLCanvasElement.md#onwaiting)
- [onwebkitanimationend](main_module._internal_.HTMLCanvasElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](main_module._internal_.HTMLCanvasElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](main_module._internal_.HTMLCanvasElement.md#onwebkitanimationstart)
- [onwebkittransitionend](main_module._internal_.HTMLCanvasElement.md#onwebkittransitionend)
- [onwheel](main_module._internal_.HTMLCanvasElement.md#onwheel)
- [outerHTML](main_module._internal_.HTMLCanvasElement.md#outerhtml)
- [outerText](main_module._internal_.HTMLCanvasElement.md#outertext)
- [ownerDocument](main_module._internal_.HTMLCanvasElement.md#ownerdocument)
- [parentElement](main_module._internal_.HTMLCanvasElement.md#parentelement)
- [parentNode](main_module._internal_.HTMLCanvasElement.md#parentnode)
- [part](main_module._internal_.HTMLCanvasElement.md#part)
- [prefix](main_module._internal_.HTMLCanvasElement.md#prefix)
- [previousElementSibling](main_module._internal_.HTMLCanvasElement.md#previouselementsibling)
- [previousSibling](main_module._internal_.HTMLCanvasElement.md#previoussibling)
- [scrollHeight](main_module._internal_.HTMLCanvasElement.md#scrollheight)
- [scrollLeft](main_module._internal_.HTMLCanvasElement.md#scrollleft)
- [scrollTop](main_module._internal_.HTMLCanvasElement.md#scrolltop)
- [scrollWidth](main_module._internal_.HTMLCanvasElement.md#scrollwidth)
- [shadowRoot](main_module._internal_.HTMLCanvasElement.md#shadowroot)
- [slot](main_module._internal_.HTMLCanvasElement.md#slot)
- [spellcheck](main_module._internal_.HTMLCanvasElement.md#spellcheck)
- [style](main_module._internal_.HTMLCanvasElement.md#style)
- [tabIndex](main_module._internal_.HTMLCanvasElement.md#tabindex)
- [tagName](main_module._internal_.HTMLCanvasElement.md#tagname)
- [textContent](main_module._internal_.HTMLCanvasElement.md#textcontent)
- [title](main_module._internal_.HTMLCanvasElement.md#title)
- [translate](main_module._internal_.HTMLCanvasElement.md#translate)
- [width](main_module._internal_.HTMLCanvasElement.md#width)

### Methods

- [addEventListener](main_module._internal_.HTMLCanvasElement.md#addeventlistener)
- [after](main_module._internal_.HTMLCanvasElement.md#after)
- [animate](main_module._internal_.HTMLCanvasElement.md#animate)
- [append](main_module._internal_.HTMLCanvasElement.md#append)
- [appendChild](main_module._internal_.HTMLCanvasElement.md#appendchild)
- [attachInternals](main_module._internal_.HTMLCanvasElement.md#attachinternals)
- [attachShadow](main_module._internal_.HTMLCanvasElement.md#attachshadow)
- [before](main_module._internal_.HTMLCanvasElement.md#before)
- [blur](main_module._internal_.HTMLCanvasElement.md#blur)
- [captureStream](main_module._internal_.HTMLCanvasElement.md#capturestream)
- [click](main_module._internal_.HTMLCanvasElement.md#click)
- [cloneNode](main_module._internal_.HTMLCanvasElement.md#clonenode)
- [closest](main_module._internal_.HTMLCanvasElement.md#closest)
- [compareDocumentPosition](main_module._internal_.HTMLCanvasElement.md#comparedocumentposition)
- [contains](main_module._internal_.HTMLCanvasElement.md#contains)
- [dispatchEvent](main_module._internal_.HTMLCanvasElement.md#dispatchevent)
- [focus](main_module._internal_.HTMLCanvasElement.md#focus)
- [getAnimations](main_module._internal_.HTMLCanvasElement.md#getanimations)
- [getAttribute](main_module._internal_.HTMLCanvasElement.md#getattribute)
- [getAttributeNS](main_module._internal_.HTMLCanvasElement.md#getattributens)
- [getAttributeNames](main_module._internal_.HTMLCanvasElement.md#getattributenames)
- [getAttributeNode](main_module._internal_.HTMLCanvasElement.md#getattributenode)
- [getAttributeNodeNS](main_module._internal_.HTMLCanvasElement.md#getattributenodens)
- [getBoundingClientRect](main_module._internal_.HTMLCanvasElement.md#getboundingclientrect)
- [getClientRects](main_module._internal_.HTMLCanvasElement.md#getclientrects)
- [getContext](main_module._internal_.HTMLCanvasElement.md#getcontext)
- [getElementsByClassName](main_module._internal_.HTMLCanvasElement.md#getelementsbyclassname)
- [getElementsByTagName](main_module._internal_.HTMLCanvasElement.md#getelementsbytagname)
- [getElementsByTagNameNS](main_module._internal_.HTMLCanvasElement.md#getelementsbytagnamens)
- [getRootNode](main_module._internal_.HTMLCanvasElement.md#getrootnode)
- [hasAttribute](main_module._internal_.HTMLCanvasElement.md#hasattribute)
- [hasAttributeNS](main_module._internal_.HTMLCanvasElement.md#hasattributens)
- [hasAttributes](main_module._internal_.HTMLCanvasElement.md#hasattributes)
- [hasChildNodes](main_module._internal_.HTMLCanvasElement.md#haschildnodes)
- [hasPointerCapture](main_module._internal_.HTMLCanvasElement.md#haspointercapture)
- [insertAdjacentElement](main_module._internal_.HTMLCanvasElement.md#insertadjacentelement)
- [insertAdjacentHTML](main_module._internal_.HTMLCanvasElement.md#insertadjacenthtml)
- [insertAdjacentText](main_module._internal_.HTMLCanvasElement.md#insertadjacenttext)
- [insertBefore](main_module._internal_.HTMLCanvasElement.md#insertbefore)
- [isDefaultNamespace](main_module._internal_.HTMLCanvasElement.md#isdefaultnamespace)
- [isEqualNode](main_module._internal_.HTMLCanvasElement.md#isequalnode)
- [isSameNode](main_module._internal_.HTMLCanvasElement.md#issamenode)
- [lookupNamespaceURI](main_module._internal_.HTMLCanvasElement.md#lookupnamespaceuri)
- [lookupPrefix](main_module._internal_.HTMLCanvasElement.md#lookupprefix)
- [matches](main_module._internal_.HTMLCanvasElement.md#matches)
- [normalize](main_module._internal_.HTMLCanvasElement.md#normalize)
- [prepend](main_module._internal_.HTMLCanvasElement.md#prepend)
- [querySelector](main_module._internal_.HTMLCanvasElement.md#queryselector)
- [querySelectorAll](main_module._internal_.HTMLCanvasElement.md#queryselectorall)
- [releasePointerCapture](main_module._internal_.HTMLCanvasElement.md#releasepointercapture)
- [remove](main_module._internal_.HTMLCanvasElement.md#remove)
- [removeAttribute](main_module._internal_.HTMLCanvasElement.md#removeattribute)
- [removeAttributeNS](main_module._internal_.HTMLCanvasElement.md#removeattributens)
- [removeAttributeNode](main_module._internal_.HTMLCanvasElement.md#removeattributenode)
- [removeChild](main_module._internal_.HTMLCanvasElement.md#removechild)
- [removeEventListener](main_module._internal_.HTMLCanvasElement.md#removeeventlistener)
- [replaceChild](main_module._internal_.HTMLCanvasElement.md#replacechild)
- [replaceChildren](main_module._internal_.HTMLCanvasElement.md#replacechildren)
- [replaceWith](main_module._internal_.HTMLCanvasElement.md#replacewith)
- [requestFullscreen](main_module._internal_.HTMLCanvasElement.md#requestfullscreen)
- [requestPointerLock](main_module._internal_.HTMLCanvasElement.md#requestpointerlock)
- [scroll](main_module._internal_.HTMLCanvasElement.md#scroll)
- [scrollBy](main_module._internal_.HTMLCanvasElement.md#scrollby)
- [scrollIntoView](main_module._internal_.HTMLCanvasElement.md#scrollintoview)
- [scrollTo](main_module._internal_.HTMLCanvasElement.md#scrollto)
- [setAttribute](main_module._internal_.HTMLCanvasElement.md#setattribute)
- [setAttributeNS](main_module._internal_.HTMLCanvasElement.md#setattributens)
- [setAttributeNode](main_module._internal_.HTMLCanvasElement.md#setattributenode)
- [setAttributeNodeNS](main_module._internal_.HTMLCanvasElement.md#setattributenodens)
- [setPointerCapture](main_module._internal_.HTMLCanvasElement.md#setpointercapture)
- [toBlob](main_module._internal_.HTMLCanvasElement.md#toblob)
- [toDataURL](main_module._internal_.HTMLCanvasElement.md#todataurl)
- [toggleAttribute](main_module._internal_.HTMLCanvasElement.md#toggleattribute)
- [webkitMatchesSelector](main_module._internal_.HTMLCanvasElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLCanvasElement`](../modules/main_module._internal_.md#htmlcanvaselement), `ev`: [`HTMLElementEventMap`](main_module._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
▸ **captureStream**(`frameRequestRate?`): [`MediaStream`](../modules/main_module._internal_.md#mediastream)
...
▸ **getContext**(`contextId`, `options?`): ``null`` \| [`CanvasRenderingContext2D`](../modules/main_module._internal_.md#canvasrenderingcontext2d)
...
| `options?` | [`CanvasRenderingContext2DSettings`](main_module._internal_.CanvasRenderingContext2DSettings.md) | - |

#### Returns

``null`` \| [`CanvasRenderingContext2D`](../modules/main_module._internal_.md#canvasrenderingcontext2d)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6163

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`ImageBitmapRenderingContext`](../modules/main_module._internal_.md#imagebitmaprenderingcontext)
...
| `options?` | [`ImageBitmapRenderingContextSettings`](main_module._internal_.ImageBitmapRenderingContextSettings.md) |

#### Returns

``null`` \| [`ImageBitmapRenderingContext`](../modules/main_module._internal_.md#imagebitmaprenderingcontext)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6164

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`WebGLRenderingContext`](../modules/main_module._internal_.md#webglrenderingcontext)
...
| :------ | :------ |
| `contextId` | ``"webgl"`` |
| `options?` | [`WebGLContextAttributes`](main_module._internal_.WebGLContextAttributes.md) |

#### Returns

``null`` \| [`WebGLRenderingContext`](../modules/main_module._internal_.md#webglrenderingcontext)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6165

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`WebGL2RenderingContext`](../modules/main_module._internal_.md#webgl2renderingcontext)
...
``null`` \| [`WebGL2RenderingContext`](../modules/main_module._internal_.md#webgl2renderingcontext)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6166

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`RenderingContext`](../modules/main_module._internal_.md#renderingcontext)
...
``null`` \| [`RenderingContext`](../modules/main_module._internal_.md#renderingcontext)
...
| Name | Type |
| :------ | :------ |
| `callback` | [`BlobCallback`](main_module._internal_.BlobCallback.md) |
| `type?` | `string` |
| `quality?` | `any` |
