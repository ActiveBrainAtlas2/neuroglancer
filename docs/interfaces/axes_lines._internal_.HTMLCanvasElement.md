[neuroglancer](../README.md) / [Modules](../modules.md) / [axes\_lines](../modules/axes_lines.md) / [<internal\>](../modules/axes_lines._internal_.md) / HTMLCanvasElement

# Interface: HTMLCanvasElement

[axes_lines](../modules/axes_lines.md).[<internal>](../modules/axes_lines._internal_.md).HTMLCanvasElement
...
- [ATTRIBUTE\_NODE](axes_lines._internal_.HTMLCanvasElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](axes_lines._internal_.HTMLCanvasElement.md#cdata_section_node)
- [COMMENT\_NODE](axes_lines._internal_.HTMLCanvasElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](axes_lines._internal_.HTMLCanvasElement.md#document_fragment_node)
- [DOCUMENT\_NODE](axes_lines._internal_.HTMLCanvasElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](axes_lines._internal_.HTMLCanvasElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](axes_lines._internal_.HTMLCanvasElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](axes_lines._internal_.HTMLCanvasElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](axes_lines._internal_.HTMLCanvasElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](axes_lines._internal_.HTMLCanvasElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](axes_lines._internal_.HTMLCanvasElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](axes_lines._internal_.HTMLCanvasElement.md#document_type_node)
- [ELEMENT\_NODE](axes_lines._internal_.HTMLCanvasElement.md#element_node)
- [ENTITY\_NODE](axes_lines._internal_.HTMLCanvasElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](axes_lines._internal_.HTMLCanvasElement.md#entity_reference_node)
- [NOTATION\_NODE](axes_lines._internal_.HTMLCanvasElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](axes_lines._internal_.HTMLCanvasElement.md#processing_instruction_node)
- [TEXT\_NODE](axes_lines._internal_.HTMLCanvasElement.md#text_node)
- [accessKey](axes_lines._internal_.HTMLCanvasElement.md#accesskey)
- [accessKeyLabel](axes_lines._internal_.HTMLCanvasElement.md#accesskeylabel)
- [ariaAtomic](axes_lines._internal_.HTMLCanvasElement.md#ariaatomic)
- [ariaAutoComplete](axes_lines._internal_.HTMLCanvasElement.md#ariaautocomplete)
- [ariaBusy](axes_lines._internal_.HTMLCanvasElement.md#ariabusy)
- [ariaChecked](axes_lines._internal_.HTMLCanvasElement.md#ariachecked)
- [ariaColCount](axes_lines._internal_.HTMLCanvasElement.md#ariacolcount)
- [ariaColIndex](axes_lines._internal_.HTMLCanvasElement.md#ariacolindex)
- [ariaColSpan](axes_lines._internal_.HTMLCanvasElement.md#ariacolspan)
- [ariaCurrent](axes_lines._internal_.HTMLCanvasElement.md#ariacurrent)
- [ariaDisabled](axes_lines._internal_.HTMLCanvasElement.md#ariadisabled)
- [ariaExpanded](axes_lines._internal_.HTMLCanvasElement.md#ariaexpanded)
- [ariaHasPopup](axes_lines._internal_.HTMLCanvasElement.md#ariahaspopup)
- [ariaHidden](axes_lines._internal_.HTMLCanvasElement.md#ariahidden)
- [ariaKeyShortcuts](axes_lines._internal_.HTMLCanvasElement.md#ariakeyshortcuts)
- [ariaLabel](axes_lines._internal_.HTMLCanvasElement.md#arialabel)
- [ariaLevel](axes_lines._internal_.HTMLCanvasElement.md#arialevel)
- [ariaLive](axes_lines._internal_.HTMLCanvasElement.md#arialive)
- [ariaModal](axes_lines._internal_.HTMLCanvasElement.md#ariamodal)
- [ariaMultiLine](axes_lines._internal_.HTMLCanvasElement.md#ariamultiline)
- [ariaMultiSelectable](axes_lines._internal_.HTMLCanvasElement.md#ariamultiselectable)
- [ariaOrientation](axes_lines._internal_.HTMLCanvasElement.md#ariaorientation)
- [ariaPlaceholder](axes_lines._internal_.HTMLCanvasElement.md#ariaplaceholder)
- [ariaPosInSet](axes_lines._internal_.HTMLCanvasElement.md#ariaposinset)
- [ariaPressed](axes_lines._internal_.HTMLCanvasElement.md#ariapressed)
- [ariaReadOnly](axes_lines._internal_.HTMLCanvasElement.md#ariareadonly)
- [ariaRequired](axes_lines._internal_.HTMLCanvasElement.md#ariarequired)
- [ariaRoleDescription](axes_lines._internal_.HTMLCanvasElement.md#ariaroledescription)
- [ariaRowCount](axes_lines._internal_.HTMLCanvasElement.md#ariarowcount)
- [ariaRowIndex](axes_lines._internal_.HTMLCanvasElement.md#ariarowindex)
- [ariaRowSpan](axes_lines._internal_.HTMLCanvasElement.md#ariarowspan)
- [ariaSelected](axes_lines._internal_.HTMLCanvasElement.md#ariaselected)
- [ariaSetSize](axes_lines._internal_.HTMLCanvasElement.md#ariasetsize)
- [ariaSort](axes_lines._internal_.HTMLCanvasElement.md#ariasort)
- [ariaValueMax](axes_lines._internal_.HTMLCanvasElement.md#ariavaluemax)
- [ariaValueMin](axes_lines._internal_.HTMLCanvasElement.md#ariavaluemin)
- [ariaValueNow](axes_lines._internal_.HTMLCanvasElement.md#ariavaluenow)
- [ariaValueText](axes_lines._internal_.HTMLCanvasElement.md#ariavaluetext)
- [assignedSlot](axes_lines._internal_.HTMLCanvasElement.md#assignedslot)
- [attributes](axes_lines._internal_.HTMLCanvasElement.md#attributes)
- [autocapitalize](axes_lines._internal_.HTMLCanvasElement.md#autocapitalize)
- [autofocus](axes_lines._internal_.HTMLCanvasElement.md#autofocus)
- [baseURI](axes_lines._internal_.HTMLCanvasElement.md#baseuri)
- [childElementCount](axes_lines._internal_.HTMLCanvasElement.md#childelementcount)
- [childNodes](axes_lines._internal_.HTMLCanvasElement.md#childnodes)
- [children](axes_lines._internal_.HTMLCanvasElement.md#children)
- [classList](axes_lines._internal_.HTMLCanvasElement.md#classlist)
- [className](axes_lines._internal_.HTMLCanvasElement.md#classname)
- [clientHeight](axes_lines._internal_.HTMLCanvasElement.md#clientheight)
- [clientLeft](axes_lines._internal_.HTMLCanvasElement.md#clientleft)
- [clientTop](axes_lines._internal_.HTMLCanvasElement.md#clienttop)
- [clientWidth](axes_lines._internal_.HTMLCanvasElement.md#clientwidth)
- [contentEditable](axes_lines._internal_.HTMLCanvasElement.md#contenteditable)
- [dataset](axes_lines._internal_.HTMLCanvasElement.md#dataset)
- [dir](axes_lines._internal_.HTMLCanvasElement.md#dir)
- [draggable](axes_lines._internal_.HTMLCanvasElement.md#draggable)
- [enterKeyHint](axes_lines._internal_.HTMLCanvasElement.md#enterkeyhint)
- [firstChild](axes_lines._internal_.HTMLCanvasElement.md#firstchild)
- [firstElementChild](axes_lines._internal_.HTMLCanvasElement.md#firstelementchild)
- [height](axes_lines._internal_.HTMLCanvasElement.md#height)
- [hidden](axes_lines._internal_.HTMLCanvasElement.md#hidden)
- [id](axes_lines._internal_.HTMLCanvasElement.md#id)
- [innerHTML](axes_lines._internal_.HTMLCanvasElement.md#innerhtml)
- [innerText](axes_lines._internal_.HTMLCanvasElement.md#innertext)
- [inputMode](axes_lines._internal_.HTMLCanvasElement.md#inputmode)
- [isConnected](axes_lines._internal_.HTMLCanvasElement.md#isconnected)
- [isContentEditable](axes_lines._internal_.HTMLCanvasElement.md#iscontenteditable)
- [lang](axes_lines._internal_.HTMLCanvasElement.md#lang)
- [lastChild](axes_lines._internal_.HTMLCanvasElement.md#lastchild)
- [lastElementChild](axes_lines._internal_.HTMLCanvasElement.md#lastelementchild)
- [localName](axes_lines._internal_.HTMLCanvasElement.md#localname)
- [namespaceURI](axes_lines._internal_.HTMLCanvasElement.md#namespaceuri)
- [nextElementSibling](axes_lines._internal_.HTMLCanvasElement.md#nextelementsibling)
- [nextSibling](axes_lines._internal_.HTMLCanvasElement.md#nextsibling)
- [nodeName](axes_lines._internal_.HTMLCanvasElement.md#nodename)
- [nodeType](axes_lines._internal_.HTMLCanvasElement.md#nodetype)
- [nodeValue](axes_lines._internal_.HTMLCanvasElement.md#nodevalue)
- [nonce](axes_lines._internal_.HTMLCanvasElement.md#nonce)
- [offsetHeight](axes_lines._internal_.HTMLCanvasElement.md#offsetheight)
- [offsetLeft](axes_lines._internal_.HTMLCanvasElement.md#offsetleft)
- [offsetParent](axes_lines._internal_.HTMLCanvasElement.md#offsetparent)
- [offsetTop](axes_lines._internal_.HTMLCanvasElement.md#offsettop)
- [offsetWidth](axes_lines._internal_.HTMLCanvasElement.md#offsetwidth)
- [onabort](axes_lines._internal_.HTMLCanvasElement.md#onabort)
- [onanimationcancel](axes_lines._internal_.HTMLCanvasElement.md#onanimationcancel)
- [onanimationend](axes_lines._internal_.HTMLCanvasElement.md#onanimationend)
- [onanimationiteration](axes_lines._internal_.HTMLCanvasElement.md#onanimationiteration)
- [onanimationstart](axes_lines._internal_.HTMLCanvasElement.md#onanimationstart)
- [onauxclick](axes_lines._internal_.HTMLCanvasElement.md#onauxclick)
- [onblur](axes_lines._internal_.HTMLCanvasElement.md#onblur)
- [oncanplay](axes_lines._internal_.HTMLCanvasElement.md#oncanplay)
- [oncanplaythrough](axes_lines._internal_.HTMLCanvasElement.md#oncanplaythrough)
- [onchange](axes_lines._internal_.HTMLCanvasElement.md#onchange)
- [onclick](axes_lines._internal_.HTMLCanvasElement.md#onclick)
- [onclose](axes_lines._internal_.HTMLCanvasElement.md#onclose)
- [oncontextmenu](axes_lines._internal_.HTMLCanvasElement.md#oncontextmenu)
- [oncopy](axes_lines._internal_.HTMLCanvasElement.md#oncopy)
- [oncuechange](axes_lines._internal_.HTMLCanvasElement.md#oncuechange)
- [oncut](axes_lines._internal_.HTMLCanvasElement.md#oncut)
- [ondblclick](axes_lines._internal_.HTMLCanvasElement.md#ondblclick)
- [ondrag](axes_lines._internal_.HTMLCanvasElement.md#ondrag)
- [ondragend](axes_lines._internal_.HTMLCanvasElement.md#ondragend)
- [ondragenter](axes_lines._internal_.HTMLCanvasElement.md#ondragenter)
- [ondragleave](axes_lines._internal_.HTMLCanvasElement.md#ondragleave)
- [ondragover](axes_lines._internal_.HTMLCanvasElement.md#ondragover)
- [ondragstart](axes_lines._internal_.HTMLCanvasElement.md#ondragstart)
- [ondrop](axes_lines._internal_.HTMLCanvasElement.md#ondrop)
- [ondurationchange](axes_lines._internal_.HTMLCanvasElement.md#ondurationchange)
- [onemptied](axes_lines._internal_.HTMLCanvasElement.md#onemptied)
- [onended](axes_lines._internal_.HTMLCanvasElement.md#onended)
- [onerror](axes_lines._internal_.HTMLCanvasElement.md#onerror)
- [onfocus](axes_lines._internal_.HTMLCanvasElement.md#onfocus)
- [onformdata](axes_lines._internal_.HTMLCanvasElement.md#onformdata)
- [onfullscreenchange](axes_lines._internal_.HTMLCanvasElement.md#onfullscreenchange)
- [onfullscreenerror](axes_lines._internal_.HTMLCanvasElement.md#onfullscreenerror)
- [ongotpointercapture](axes_lines._internal_.HTMLCanvasElement.md#ongotpointercapture)
- [oninput](axes_lines._internal_.HTMLCanvasElement.md#oninput)
- [oninvalid](axes_lines._internal_.HTMLCanvasElement.md#oninvalid)
- [onkeydown](axes_lines._internal_.HTMLCanvasElement.md#onkeydown)
- [onkeypress](axes_lines._internal_.HTMLCanvasElement.md#onkeypress)
- [onkeyup](axes_lines._internal_.HTMLCanvasElement.md#onkeyup)
- [onload](axes_lines._internal_.HTMLCanvasElement.md#onload)
- [onloadeddata](axes_lines._internal_.HTMLCanvasElement.md#onloadeddata)
- [onloadedmetadata](axes_lines._internal_.HTMLCanvasElement.md#onloadedmetadata)
- [onloadstart](axes_lines._internal_.HTMLCanvasElement.md#onloadstart)
- [onlostpointercapture](axes_lines._internal_.HTMLCanvasElement.md#onlostpointercapture)
- [onmousedown](axes_lines._internal_.HTMLCanvasElement.md#onmousedown)
- [onmouseenter](axes_lines._internal_.HTMLCanvasElement.md#onmouseenter)
- [onmouseleave](axes_lines._internal_.HTMLCanvasElement.md#onmouseleave)
- [onmousemove](axes_lines._internal_.HTMLCanvasElement.md#onmousemove)
- [onmouseout](axes_lines._internal_.HTMLCanvasElement.md#onmouseout)
- [onmouseover](axes_lines._internal_.HTMLCanvasElement.md#onmouseover)
- [onmouseup](axes_lines._internal_.HTMLCanvasElement.md#onmouseup)
- [onpaste](axes_lines._internal_.HTMLCanvasElement.md#onpaste)
- [onpause](axes_lines._internal_.HTMLCanvasElement.md#onpause)
- [onplay](axes_lines._internal_.HTMLCanvasElement.md#onplay)
- [onplaying](axes_lines._internal_.HTMLCanvasElement.md#onplaying)
- [onpointercancel](axes_lines._internal_.HTMLCanvasElement.md#onpointercancel)
- [onpointerdown](axes_lines._internal_.HTMLCanvasElement.md#onpointerdown)
- [onpointerenter](axes_lines._internal_.HTMLCanvasElement.md#onpointerenter)
- [onpointerleave](axes_lines._internal_.HTMLCanvasElement.md#onpointerleave)
- [onpointermove](axes_lines._internal_.HTMLCanvasElement.md#onpointermove)
- [onpointerout](axes_lines._internal_.HTMLCanvasElement.md#onpointerout)
- [onpointerover](axes_lines._internal_.HTMLCanvasElement.md#onpointerover)
- [onpointerup](axes_lines._internal_.HTMLCanvasElement.md#onpointerup)
- [onprogress](axes_lines._internal_.HTMLCanvasElement.md#onprogress)
- [onratechange](axes_lines._internal_.HTMLCanvasElement.md#onratechange)
- [onreset](axes_lines._internal_.HTMLCanvasElement.md#onreset)
- [onresize](axes_lines._internal_.HTMLCanvasElement.md#onresize)
- [onscroll](axes_lines._internal_.HTMLCanvasElement.md#onscroll)
- [onsecuritypolicyviolation](axes_lines._internal_.HTMLCanvasElement.md#onsecuritypolicyviolation)
- [onseeked](axes_lines._internal_.HTMLCanvasElement.md#onseeked)
- [onseeking](axes_lines._internal_.HTMLCanvasElement.md#onseeking)
- [onselect](axes_lines._internal_.HTMLCanvasElement.md#onselect)
- [onselectionchange](axes_lines._internal_.HTMLCanvasElement.md#onselectionchange)
- [onselectstart](axes_lines._internal_.HTMLCanvasElement.md#onselectstart)
- [onslotchange](axes_lines._internal_.HTMLCanvasElement.md#onslotchange)
- [onstalled](axes_lines._internal_.HTMLCanvasElement.md#onstalled)
- [onsubmit](axes_lines._internal_.HTMLCanvasElement.md#onsubmit)
- [onsuspend](axes_lines._internal_.HTMLCanvasElement.md#onsuspend)
- [ontimeupdate](axes_lines._internal_.HTMLCanvasElement.md#ontimeupdate)
- [ontoggle](axes_lines._internal_.HTMLCanvasElement.md#ontoggle)
- [ontouchcancel](axes_lines._internal_.HTMLCanvasElement.md#ontouchcancel)
- [ontouchend](axes_lines._internal_.HTMLCanvasElement.md#ontouchend)
- [ontouchmove](axes_lines._internal_.HTMLCanvasElement.md#ontouchmove)
- [ontouchstart](axes_lines._internal_.HTMLCanvasElement.md#ontouchstart)
- [ontransitioncancel](axes_lines._internal_.HTMLCanvasElement.md#ontransitioncancel)
- [ontransitionend](axes_lines._internal_.HTMLCanvasElement.md#ontransitionend)
- [ontransitionrun](axes_lines._internal_.HTMLCanvasElement.md#ontransitionrun)
- [ontransitionstart](axes_lines._internal_.HTMLCanvasElement.md#ontransitionstart)
- [onvolumechange](axes_lines._internal_.HTMLCanvasElement.md#onvolumechange)
- [onwaiting](axes_lines._internal_.HTMLCanvasElement.md#onwaiting)
- [onwebkitanimationend](axes_lines._internal_.HTMLCanvasElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](axes_lines._internal_.HTMLCanvasElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](axes_lines._internal_.HTMLCanvasElement.md#onwebkitanimationstart)
- [onwebkittransitionend](axes_lines._internal_.HTMLCanvasElement.md#onwebkittransitionend)
- [onwheel](axes_lines._internal_.HTMLCanvasElement.md#onwheel)
- [outerHTML](axes_lines._internal_.HTMLCanvasElement.md#outerhtml)
- [outerText](axes_lines._internal_.HTMLCanvasElement.md#outertext)
- [ownerDocument](axes_lines._internal_.HTMLCanvasElement.md#ownerdocument)
- [parentElement](axes_lines._internal_.HTMLCanvasElement.md#parentelement)
- [parentNode](axes_lines._internal_.HTMLCanvasElement.md#parentnode)
- [part](axes_lines._internal_.HTMLCanvasElement.md#part)
- [prefix](axes_lines._internal_.HTMLCanvasElement.md#prefix)
- [previousElementSibling](axes_lines._internal_.HTMLCanvasElement.md#previouselementsibling)
- [previousSibling](axes_lines._internal_.HTMLCanvasElement.md#previoussibling)
- [scrollHeight](axes_lines._internal_.HTMLCanvasElement.md#scrollheight)
- [scrollLeft](axes_lines._internal_.HTMLCanvasElement.md#scrollleft)
- [scrollTop](axes_lines._internal_.HTMLCanvasElement.md#scrolltop)
- [scrollWidth](axes_lines._internal_.HTMLCanvasElement.md#scrollwidth)
- [shadowRoot](axes_lines._internal_.HTMLCanvasElement.md#shadowroot)
- [slot](axes_lines._internal_.HTMLCanvasElement.md#slot)
- [spellcheck](axes_lines._internal_.HTMLCanvasElement.md#spellcheck)
- [style](axes_lines._internal_.HTMLCanvasElement.md#style)
- [tabIndex](axes_lines._internal_.HTMLCanvasElement.md#tabindex)
- [tagName](axes_lines._internal_.HTMLCanvasElement.md#tagname)
- [textContent](axes_lines._internal_.HTMLCanvasElement.md#textcontent)
- [title](axes_lines._internal_.HTMLCanvasElement.md#title)
- [translate](axes_lines._internal_.HTMLCanvasElement.md#translate)
- [width](axes_lines._internal_.HTMLCanvasElement.md#width)

### Methods

- [addEventListener](axes_lines._internal_.HTMLCanvasElement.md#addeventlistener)
- [after](axes_lines._internal_.HTMLCanvasElement.md#after)
- [animate](axes_lines._internal_.HTMLCanvasElement.md#animate)
- [append](axes_lines._internal_.HTMLCanvasElement.md#append)
- [appendChild](axes_lines._internal_.HTMLCanvasElement.md#appendchild)
- [attachInternals](axes_lines._internal_.HTMLCanvasElement.md#attachinternals)
- [attachShadow](axes_lines._internal_.HTMLCanvasElement.md#attachshadow)
- [before](axes_lines._internal_.HTMLCanvasElement.md#before)
- [blur](axes_lines._internal_.HTMLCanvasElement.md#blur)
- [captureStream](axes_lines._internal_.HTMLCanvasElement.md#capturestream)
- [click](axes_lines._internal_.HTMLCanvasElement.md#click)
- [cloneNode](axes_lines._internal_.HTMLCanvasElement.md#clonenode)
- [closest](axes_lines._internal_.HTMLCanvasElement.md#closest)
- [compareDocumentPosition](axes_lines._internal_.HTMLCanvasElement.md#comparedocumentposition)
- [contains](axes_lines._internal_.HTMLCanvasElement.md#contains)
- [dispatchEvent](axes_lines._internal_.HTMLCanvasElement.md#dispatchevent)
- [focus](axes_lines._internal_.HTMLCanvasElement.md#focus)
- [getAnimations](axes_lines._internal_.HTMLCanvasElement.md#getanimations)
- [getAttribute](axes_lines._internal_.HTMLCanvasElement.md#getattribute)
- [getAttributeNS](axes_lines._internal_.HTMLCanvasElement.md#getattributens)
- [getAttributeNames](axes_lines._internal_.HTMLCanvasElement.md#getattributenames)
- [getAttributeNode](axes_lines._internal_.HTMLCanvasElement.md#getattributenode)
- [getAttributeNodeNS](axes_lines._internal_.HTMLCanvasElement.md#getattributenodens)
- [getBoundingClientRect](axes_lines._internal_.HTMLCanvasElement.md#getboundingclientrect)
- [getClientRects](axes_lines._internal_.HTMLCanvasElement.md#getclientrects)
- [getContext](axes_lines._internal_.HTMLCanvasElement.md#getcontext)
- [getElementsByClassName](axes_lines._internal_.HTMLCanvasElement.md#getelementsbyclassname)
- [getElementsByTagName](axes_lines._internal_.HTMLCanvasElement.md#getelementsbytagname)
- [getElementsByTagNameNS](axes_lines._internal_.HTMLCanvasElement.md#getelementsbytagnamens)
- [getRootNode](axes_lines._internal_.HTMLCanvasElement.md#getrootnode)
- [hasAttribute](axes_lines._internal_.HTMLCanvasElement.md#hasattribute)
- [hasAttributeNS](axes_lines._internal_.HTMLCanvasElement.md#hasattributens)
- [hasAttributes](axes_lines._internal_.HTMLCanvasElement.md#hasattributes)
- [hasChildNodes](axes_lines._internal_.HTMLCanvasElement.md#haschildnodes)
- [hasPointerCapture](axes_lines._internal_.HTMLCanvasElement.md#haspointercapture)
- [insertAdjacentElement](axes_lines._internal_.HTMLCanvasElement.md#insertadjacentelement)
- [insertAdjacentHTML](axes_lines._internal_.HTMLCanvasElement.md#insertadjacenthtml)
- [insertAdjacentText](axes_lines._internal_.HTMLCanvasElement.md#insertadjacenttext)
- [insertBefore](axes_lines._internal_.HTMLCanvasElement.md#insertbefore)
- [isDefaultNamespace](axes_lines._internal_.HTMLCanvasElement.md#isdefaultnamespace)
- [isEqualNode](axes_lines._internal_.HTMLCanvasElement.md#isequalnode)
- [isSameNode](axes_lines._internal_.HTMLCanvasElement.md#issamenode)
- [lookupNamespaceURI](axes_lines._internal_.HTMLCanvasElement.md#lookupnamespaceuri)
- [lookupPrefix](axes_lines._internal_.HTMLCanvasElement.md#lookupprefix)
- [matches](axes_lines._internal_.HTMLCanvasElement.md#matches)
- [normalize](axes_lines._internal_.HTMLCanvasElement.md#normalize)
- [prepend](axes_lines._internal_.HTMLCanvasElement.md#prepend)
- [querySelector](axes_lines._internal_.HTMLCanvasElement.md#queryselector)
- [querySelectorAll](axes_lines._internal_.HTMLCanvasElement.md#queryselectorall)
- [releasePointerCapture](axes_lines._internal_.HTMLCanvasElement.md#releasepointercapture)
- [remove](axes_lines._internal_.HTMLCanvasElement.md#remove)
- [removeAttribute](axes_lines._internal_.HTMLCanvasElement.md#removeattribute)
- [removeAttributeNS](axes_lines._internal_.HTMLCanvasElement.md#removeattributens)
- [removeAttributeNode](axes_lines._internal_.HTMLCanvasElement.md#removeattributenode)
- [removeChild](axes_lines._internal_.HTMLCanvasElement.md#removechild)
- [removeEventListener](axes_lines._internal_.HTMLCanvasElement.md#removeeventlistener)
- [replaceChild](axes_lines._internal_.HTMLCanvasElement.md#replacechild)
- [replaceChildren](axes_lines._internal_.HTMLCanvasElement.md#replacechildren)
- [replaceWith](axes_lines._internal_.HTMLCanvasElement.md#replacewith)
- [requestFullscreen](axes_lines._internal_.HTMLCanvasElement.md#requestfullscreen)
- [requestPointerLock](axes_lines._internal_.HTMLCanvasElement.md#requestpointerlock)
- [scroll](axes_lines._internal_.HTMLCanvasElement.md#scroll)
- [scrollBy](axes_lines._internal_.HTMLCanvasElement.md#scrollby)
- [scrollIntoView](axes_lines._internal_.HTMLCanvasElement.md#scrollintoview)
- [scrollTo](axes_lines._internal_.HTMLCanvasElement.md#scrollto)
- [setAttribute](axes_lines._internal_.HTMLCanvasElement.md#setattribute)
- [setAttributeNS](axes_lines._internal_.HTMLCanvasElement.md#setattributens)
- [setAttributeNode](axes_lines._internal_.HTMLCanvasElement.md#setattributenode)
- [setAttributeNodeNS](axes_lines._internal_.HTMLCanvasElement.md#setattributenodens)
- [setPointerCapture](axes_lines._internal_.HTMLCanvasElement.md#setpointercapture)
- [toBlob](axes_lines._internal_.HTMLCanvasElement.md#toblob)
- [toDataURL](axes_lines._internal_.HTMLCanvasElement.md#todataurl)
- [toggleAttribute](axes_lines._internal_.HTMLCanvasElement.md#toggleattribute)
- [webkitMatchesSelector](axes_lines._internal_.HTMLCanvasElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLCanvasElement`](../modules/axes_lines._internal_.md#htmlcanvaselement), `ev`: [`HTMLElementEventMap`](axes_lines._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
▸ **captureStream**(`frameRequestRate?`): [`MediaStream`](../modules/axes_lines._internal_.md#mediastream)
...
▸ **getContext**(`contextId`, `options?`): ``null`` \| [`CanvasRenderingContext2D`](../modules/axes_lines._internal_.md#canvasrenderingcontext2d)
...
| `options?` | [`CanvasRenderingContext2DSettings`](axes_lines._internal_.CanvasRenderingContext2DSettings.md) | - |

#### Returns

``null`` \| [`CanvasRenderingContext2D`](../modules/axes_lines._internal_.md#canvasrenderingcontext2d)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6163

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`ImageBitmapRenderingContext`](../modules/axes_lines._internal_.md#imagebitmaprenderingcontext)
...
| `options?` | [`ImageBitmapRenderingContextSettings`](axes_lines._internal_.ImageBitmapRenderingContextSettings.md) |

#### Returns

``null`` \| [`ImageBitmapRenderingContext`](../modules/axes_lines._internal_.md#imagebitmaprenderingcontext)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6164

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`WebGLRenderingContext`](../modules/axes_lines._internal_.md#webglrenderingcontext)
...
| :------ | :------ |
| `contextId` | ``"webgl"`` |
| `options?` | [`WebGLContextAttributes`](axes_lines._internal_.WebGLContextAttributes.md) |

#### Returns

``null`` \| [`WebGLRenderingContext`](../modules/axes_lines._internal_.md#webglrenderingcontext)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6165

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`WebGL2RenderingContext`](../modules/axes_lines._internal_.md#webgl2renderingcontext)
...
``null`` \| [`WebGL2RenderingContext`](../modules/axes_lines._internal_.md#webgl2renderingcontext)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6166

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`RenderingContext`](../modules/axes_lines._internal_.md#renderingcontext)
...
``null`` \| [`RenderingContext`](../modules/axes_lines._internal_.md#renderingcontext)
...
| Name | Type |
| :------ | :------ |
| `callback` | [`BlobCallback`](axes_lines._internal_.BlobCallback.md) |
| `type?` | `string` |
| `quality?` | `any` |
