[neuroglancer](../README.md) / [Exports](../modules.md) / [main\_module](../modules/main_module.md) / [<internal\>](../modules/main_module._internal_.md) / DOMMatrix

# Interface: DOMMatrix

[main_module](../modules/main_module.md).[<internal>](../modules/main_module._internal_.md).DOMMatrix

## Hierarchy

- [`DOMMatrixReadOnly`](../modules/main_module._internal_.md#dommatrixreadonly)
...
- [a](main_module._internal_.DOMMatrix.md#a)
- [b](main_module._internal_.DOMMatrix.md#b)
- [c](main_module._internal_.DOMMatrix.md#c)
- [d](main_module._internal_.DOMMatrix.md#d)
- [e](main_module._internal_.DOMMatrix.md#e)
- [f](main_module._internal_.DOMMatrix.md#f)
- [is2D](main_module._internal_.DOMMatrix.md#is2d)
- [isIdentity](main_module._internal_.DOMMatrix.md#isidentity)
- [m11](main_module._internal_.DOMMatrix.md#m11)
- [m12](main_module._internal_.DOMMatrix.md#m12)
- [m13](main_module._internal_.DOMMatrix.md#m13)
- [m14](main_module._internal_.DOMMatrix.md#m14)
- [m21](main_module._internal_.DOMMatrix.md#m21)
- [m22](main_module._internal_.DOMMatrix.md#m22)
- [m23](main_module._internal_.DOMMatrix.md#m23)
- [m24](main_module._internal_.DOMMatrix.md#m24)
- [m31](main_module._internal_.DOMMatrix.md#m31)
- [m32](main_module._internal_.DOMMatrix.md#m32)
- [m33](main_module._internal_.DOMMatrix.md#m33)
- [m34](main_module._internal_.DOMMatrix.md#m34)
- [m41](main_module._internal_.DOMMatrix.md#m41)
- [m42](main_module._internal_.DOMMatrix.md#m42)
- [m43](main_module._internal_.DOMMatrix.md#m43)
- [m44](main_module._internal_.DOMMatrix.md#m44)

### Methods

- [flipX](main_module._internal_.DOMMatrix.md#flipx)
- [flipY](main_module._internal_.DOMMatrix.md#flipy)
- [inverse](main_module._internal_.DOMMatrix.md#inverse)
- [invertSelf](main_module._internal_.DOMMatrix.md#invertself)
- [multiply](main_module._internal_.DOMMatrix.md#multiply)
- [multiplySelf](main_module._internal_.DOMMatrix.md#multiplyself)
- [preMultiplySelf](main_module._internal_.DOMMatrix.md#premultiplyself)
- [rotate](main_module._internal_.DOMMatrix.md#rotate)
- [rotateAxisAngle](main_module._internal_.DOMMatrix.md#rotateaxisangle)
- [rotateAxisAngleSelf](main_module._internal_.DOMMatrix.md#rotateaxisangleself)
- [rotateFromVector](main_module._internal_.DOMMatrix.md#rotatefromvector)
- [rotateFromVectorSelf](main_module._internal_.DOMMatrix.md#rotatefromvectorself)
- [rotateSelf](main_module._internal_.DOMMatrix.md#rotateself)
- [scale](main_module._internal_.DOMMatrix.md#scale)
- [scale3d](main_module._internal_.DOMMatrix.md#scale3d)
- [scale3dSelf](main_module._internal_.DOMMatrix.md#scale3dself)
- [scaleNonUniform](main_module._internal_.DOMMatrix.md#scalenonuniform)
- [scaleSelf](main_module._internal_.DOMMatrix.md#scaleself)
- [setMatrixValue](main_module._internal_.DOMMatrix.md#setmatrixvalue)
- [skewX](main_module._internal_.DOMMatrix.md#skewx)
- [skewXSelf](main_module._internal_.DOMMatrix.md#skewxself)
- [skewY](main_module._internal_.DOMMatrix.md#skewy)
- [skewYSelf](main_module._internal_.DOMMatrix.md#skewyself)
- [toFloat32Array](main_module._internal_.DOMMatrix.md#tofloat32array)
- [toFloat64Array](main_module._internal_.DOMMatrix.md#tofloat64array)
- [toJSON](main_module._internal_.DOMMatrix.md#tojson)
- [toString](main_module._internal_.DOMMatrix.md#tostring)
- [transformPoint](main_module._internal_.DOMMatrix.md#transformpoint)
- [translate](main_module._internal_.DOMMatrix.md#translate)
- [translateSelf](main_module._internal_.DOMMatrix.md#translateself)
...
▸ **invertSelf**(): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **multiplySelf**(`other?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **preMultiplySelf**(`other?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **rotateAxisAngleSelf**(`x?`, `y?`, `z?`, `angle?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **rotateFromVectorSelf**(`x?`, `y?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **rotateSelf**(`rotX?`, `rotY?`, `rotZ?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **scale3dSelf**(`scale?`, `originX?`, `originY?`, `originZ?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **scaleSelf**(`scaleX?`, `scaleY?`, `scaleZ?`, `originX?`, `originY?`, `originZ?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **setMatrixValue**(`transformList`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **skewXSelf**(`sx?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **skewYSelf**(`sy?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
...
▸ **translateSelf**(`tx?`, `ty?`, `tz?`): [`DOMMatrix`](../modules/main_module._internal_.md#dommatrix)
