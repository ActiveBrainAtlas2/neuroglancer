[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/sliceview/single\_texture\_chunk\_format](../modules/neuroglancer_sliceview_single_texture_chunk_format.md) / SingleTextureChunkFormat
...
- [dataType](neuroglancer_sliceview_single_texture_chunk_format.SingleTextureChunkFormat.md#datatype)
...
[src/neuroglancer/sliceview/single_texture_chunk_format.ts:30](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/sliceview/single_texture_chunk_format.ts#L30)
...
• `Abstract` `get` **shaderSamplerType**(): [`ShaderSamplerType`](../modules/neuroglancer_webgl_shader.md#shadersamplertype)
...
[src/neuroglancer/sliceview/single_texture_chunk_format.ts:39](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/sliceview/single_texture_chunk_format.ts#L39)
...
[ChunkFormat](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md).[beginDrawing](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md#begindrawing)
...
[ChunkFormat](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md).[beginSource](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md#beginsource)
...
[ChunkFormat](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md).[bindChunk](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md#bindchunk)
...
[ChunkFormat](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md).[defineShader](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md#defineshader)

#### Defined in

[src/neuroglancer/sliceview/single_texture_chunk_format.ts:34](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/sliceview/single_texture_chunk_format.ts#L34)
...
[ChunkFormat](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md).[endDrawing](../interfaces/neuroglancer_sliceview_volume_frontend.ChunkFormat.md#enddrawing)
...
[src/neuroglancer/sliceview/single_texture_chunk_format.ts:75](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/sliceview/single_texture_chunk_format.ts#L75)
...
[src/neuroglancer/sliceview/single_texture_chunk_format.ts:55](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/sliceview/single_texture_chunk_format.ts#L55)
