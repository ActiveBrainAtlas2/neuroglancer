[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/datasource/zarr/frontend](../modules/neuroglancer_datasource_zarr_frontend.md) / ZarrDataSource

# Class: ZarrDataSource

[neuroglancer/datasource/zarr/frontend](../modules/neuroglancer_datasource_zarr_frontend.md).ZarrDataSource
...
- [constructor](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#constructor)

### Properties

- [disposedStacks](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#disposedstacks)
- [refCount](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#refcount)
- [wasDisposed](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#wasdisposed)

### Accessors

- [description](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#description)

### Methods

- [addRef](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#addref)
- [completeUrl](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#completeurl)
- [convertLegacyUrl](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#convertlegacyurl)
- [dispose](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#dispose)
- [disposed](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#disposed)
- [findSourceGroup](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#findsourcegroup)
- [get](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#get)
- [normalizeUrl](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#normalizeurl)
- [refCountReachedZero](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#refcountreachedzero)
- [registerCancellable](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#registercancellable)
- [registerDisposer](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#registerdisposer)
- [registerEventListener](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#registereventlistener)
- [suggestLayerName](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#suggestlayername)
- [unregisterDisposer](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md#unregisterdisposer)
...
[src/neuroglancer/datasource/zarr/frontend.ts:240](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/datasource/zarr/frontend.ts#L240)

## Methods

### addRef

▸ **addRef**(): [`ZarrDataSource`](neuroglancer_datasource_zarr_frontend.ZarrDataSource.md)
...
[src/neuroglancer/datasource/zarr/frontend.ts:293](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/datasource/zarr/frontend.ts#L293)
...
[src/neuroglancer/datasource/zarr/frontend.ts:243](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/datasource/zarr/frontend.ts#L243)
