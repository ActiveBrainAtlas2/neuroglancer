[neuroglancer](../README.md) / [Modules](../modules.md) / [annotation/backend](../modules/annotation_backend.md) / AnnotationMetadataChunk

# Class: AnnotationMetadataChunk

[annotation/backend](../modules/annotation_backend.md).AnnotationMetadataChunk
...
- [constructor](annotation_backend.AnnotationMetadataChunk.md#constructor)

### Properties

- [annotation](annotation_backend.AnnotationMetadataChunk.md#annotation)
- [backendOnly](annotation_backend.AnnotationMetadataChunk.md#backendonly)
- [child0](annotation_backend.AnnotationMetadataChunk.md#child0)
- [child1](annotation_backend.AnnotationMetadataChunk.md#child1)
- [downloadCancellationToken](annotation_backend.AnnotationMetadataChunk.md#downloadcancellationtoken)
- [error](annotation_backend.AnnotationMetadataChunk.md#error)
- [isComputational](annotation_backend.AnnotationMetadataChunk.md#iscomputational)
- [key](annotation_backend.AnnotationMetadataChunk.md#key)
- [markGeneration](annotation_backend.AnnotationMetadataChunk.md#markgeneration)
- [newPriority](annotation_backend.AnnotationMetadataChunk.md#newpriority)
- [newPriorityTier](annotation_backend.AnnotationMetadataChunk.md#newprioritytier)
- [newlyRequestedToFrontend](annotation_backend.AnnotationMetadataChunk.md#newlyrequestedtofrontend)
- [next0](annotation_backend.AnnotationMetadataChunk.md#next0)
- [next1](annotation_backend.AnnotationMetadataChunk.md#next1)
- [prev0](annotation_backend.AnnotationMetadataChunk.md#prev0)
- [prev1](annotation_backend.AnnotationMetadataChunk.md#prev1)
- [priority](annotation_backend.AnnotationMetadataChunk.md#priority)
- [priorityTier](annotation_backend.AnnotationMetadataChunk.md#prioritytier)
- [requestedToFrontend](annotation_backend.AnnotationMetadataChunk.md#requestedtofrontend)
- [source](annotation_backend.AnnotationMetadataChunk.md#source)

### Accessors

- [chunkManager](annotation_backend.AnnotationMetadataChunk.md#chunkmanager)
- [downloadSlots](annotation_backend.AnnotationMetadataChunk.md#downloadslots)
- [gpuMemoryBytes](annotation_backend.AnnotationMetadataChunk.md#gpumemorybytes)
- [queueManager](annotation_backend.AnnotationMetadataChunk.md#queuemanager)
- [state](annotation_backend.AnnotationMetadataChunk.md#state)
- [systemMemoryBytes](annotation_backend.AnnotationMetadataChunk.md#systemmemorybytes)

### Methods

- [dispose](annotation_backend.AnnotationMetadataChunk.md#dispose)
- [downloadFailed](annotation_backend.AnnotationMetadataChunk.md#downloadfailed)
- [downloadSucceeded](annotation_backend.AnnotationMetadataChunk.md#downloadsucceeded)
- [freeSystemMemory](annotation_backend.AnnotationMetadataChunk.md#freesystemmemory)
- [initialize](annotation_backend.AnnotationMetadataChunk.md#initialize)
- [registerListener](annotation_backend.AnnotationMetadataChunk.md#registerlistener)
- [serialize](annotation_backend.AnnotationMetadataChunk.md#serialize)
- [toString](annotation_backend.AnnotationMetadataChunk.md#tostring)
- [unregisterListener](annotation_backend.AnnotationMetadataChunk.md#unregisterlistener)
- [updatePriorityProperties](annotation_backend.AnnotationMetadataChunk.md#updatepriorityproperties)
- [priorityGreater](annotation_backend.AnnotationMetadataChunk.md#prioritygreater)
- [priorityLess](annotation_backend.AnnotationMetadataChunk.md#priorityless)
...
• **annotation**: `undefined` \| ``null`` \| [`Annotation`](../modules/annotation.md#annotation)

#### Defined in

[src/neuroglancer/annotation/backend.ts:39](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/annotation/backend.ts#L39)
...
[src/neuroglancer/annotation/backend.ts:47](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/annotation/backend.ts#L47)
...
[src/neuroglancer/annotation/backend.ts:40](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/annotation/backend.ts#L40)
...
[src/neuroglancer/annotation/backend.ts:43](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/annotation/backend.ts#L43)
