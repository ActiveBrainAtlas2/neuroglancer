[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/single\_mesh/backend](../modules/neuroglancer_single_mesh_backend.md) / SingleMeshChunk

# Class: SingleMeshChunk

[neuroglancer/single_mesh/backend](../modules/neuroglancer_single_mesh_backend.md).SingleMeshChunk
...
- [constructor](neuroglancer_single_mesh_backend.SingleMeshChunk.md#constructor)

### Properties

- [backendOnly](neuroglancer_single_mesh_backend.SingleMeshChunk.md#backendonly)
- [child0](neuroglancer_single_mesh_backend.SingleMeshChunk.md#child0)
- [child1](neuroglancer_single_mesh_backend.SingleMeshChunk.md#child1)
- [data](neuroglancer_single_mesh_backend.SingleMeshChunk.md#data)
- [downloadCancellationToken](neuroglancer_single_mesh_backend.SingleMeshChunk.md#downloadcancellationtoken)
- [error](neuroglancer_single_mesh_backend.SingleMeshChunk.md#error)
- [isComputational](neuroglancer_single_mesh_backend.SingleMeshChunk.md#iscomputational)
- [key](neuroglancer_single_mesh_backend.SingleMeshChunk.md#key)
- [markGeneration](neuroglancer_single_mesh_backend.SingleMeshChunk.md#markgeneration)
- [newPriority](neuroglancer_single_mesh_backend.SingleMeshChunk.md#newpriority)
- [newPriorityTier](neuroglancer_single_mesh_backend.SingleMeshChunk.md#newprioritytier)
- [newlyRequestedToFrontend](neuroglancer_single_mesh_backend.SingleMeshChunk.md#newlyrequestedtofrontend)
- [next0](neuroglancer_single_mesh_backend.SingleMeshChunk.md#next0)
- [next1](neuroglancer_single_mesh_backend.SingleMeshChunk.md#next1)
- [prev0](neuroglancer_single_mesh_backend.SingleMeshChunk.md#prev0)
- [prev1](neuroglancer_single_mesh_backend.SingleMeshChunk.md#prev1)
- [priority](neuroglancer_single_mesh_backend.SingleMeshChunk.md#priority)
- [priorityTier](neuroglancer_single_mesh_backend.SingleMeshChunk.md#prioritytier)
- [requestedToFrontend](neuroglancer_single_mesh_backend.SingleMeshChunk.md#requestedtofrontend)
- [source](neuroglancer_single_mesh_backend.SingleMeshChunk.md#source)

### Accessors

- [chunkManager](neuroglancer_single_mesh_backend.SingleMeshChunk.md#chunkmanager)
- [downloadSlots](neuroglancer_single_mesh_backend.SingleMeshChunk.md#downloadslots)
- [gpuMemoryBytes](neuroglancer_single_mesh_backend.SingleMeshChunk.md#gpumemorybytes)
- [queueManager](neuroglancer_single_mesh_backend.SingleMeshChunk.md#queuemanager)
- [state](neuroglancer_single_mesh_backend.SingleMeshChunk.md#state)
- [systemMemoryBytes](neuroglancer_single_mesh_backend.SingleMeshChunk.md#systemmemorybytes)

### Methods

- [dispose](neuroglancer_single_mesh_backend.SingleMeshChunk.md#dispose)
- [downloadFailed](neuroglancer_single_mesh_backend.SingleMeshChunk.md#downloadfailed)
- [downloadSucceeded](neuroglancer_single_mesh_backend.SingleMeshChunk.md#downloadsucceeded)
- [freeSystemMemory](neuroglancer_single_mesh_backend.SingleMeshChunk.md#freesystemmemory)
- [initialize](neuroglancer_single_mesh_backend.SingleMeshChunk.md#initialize)
- [registerListener](neuroglancer_single_mesh_backend.SingleMeshChunk.md#registerlistener)
- [serialize](neuroglancer_single_mesh_backend.SingleMeshChunk.md#serialize)
- [toString](neuroglancer_single_mesh_backend.SingleMeshChunk.md#tostring)
- [unregisterListener](neuroglancer_single_mesh_backend.SingleMeshChunk.md#unregisterlistener)
- [updatePriorityProperties](neuroglancer_single_mesh_backend.SingleMeshChunk.md#updatepriorityproperties)
- [priorityGreater](neuroglancer_single_mesh_backend.SingleMeshChunk.md#prioritygreater)
- [priorityLess](neuroglancer_single_mesh_backend.SingleMeshChunk.md#priorityless)
...
[src/neuroglancer/single_mesh/backend.ts:38](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/single_mesh/backend.ts#L38)
...
• **data**: ``null`` \| [`SingleMeshData`](../interfaces/neuroglancer_single_mesh_base.SingleMeshData.md) = `null`

#### Defined in

[src/neuroglancer/single_mesh/backend.ts:37](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/single_mesh/backend.ts#L37)
...
[src/neuroglancer/single_mesh/backend.ts:61](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/single_mesh/backend.ts#L61)
...
[src/neuroglancer/single_mesh/backend.ts:41](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/single_mesh/backend.ts#L41)
...
[src/neuroglancer/single_mesh/backend.ts:44](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/single_mesh/backend.ts#L44)
