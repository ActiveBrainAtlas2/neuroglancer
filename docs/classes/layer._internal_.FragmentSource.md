[neuroglancer](../README.md) / [Modules](../modules.md) / [layer](../modules/layer.md) / [<internal\>](../modules/layer._internal_.md) / FragmentSource

# Class: FragmentSource

[layer](../modules/layer.md).[<internal>](../modules/layer._internal_.md).FragmentSource
...
- [constructor](layer._internal_.FragmentSource.md#constructor)

### Properties

- [OPTIONS](layer._internal_.FragmentSource.md#options)
- [RPC\_TYPE\_ID](layer._internal_.FragmentSource.md#rpc_type_id)
- [chunkManager](layer._internal_.FragmentSource.md#chunkmanager)
- [chunks](layer._internal_.FragmentSource.md#chunks)
- [disposedStacks](layer._internal_.FragmentSource.md#disposedstacks)
- [immediateChunkUpdates](layer._internal_.FragmentSource.md#immediatechunkupdates)
- [isOwner](layer._internal_.FragmentSource.md#isowner)
- [meshSource](layer._internal_.FragmentSource.md#meshsource)
- [refCount](layer._internal_.FragmentSource.md#refcount)
- [referencedGeneration](layer._internal_.FragmentSource.md#referencedgeneration)
- [rpc](layer._internal_.FragmentSource.md#rpc)
- [rpcId](layer._internal_.FragmentSource.md#rpcid)
- [unreferencedGeneration](layer._internal_.FragmentSource.md#unreferencedgeneration)
- [wasDisposed](layer._internal_.FragmentSource.md#wasdisposed)

### Accessors

- [gl](layer._internal_.FragmentSource.md#gl)
- [key](layer._internal_.FragmentSource.md#key)

### Methods

- [addChunk](layer._internal_.FragmentSource.md#addchunk)
- [addCounterpartRef](layer._internal_.FragmentSource.md#addcounterpartref)
- [addRef](layer._internal_.FragmentSource.md#addref)
- [counterpartRefCountReachedZero](layer._internal_.FragmentSource.md#counterpartrefcountreachedzero)
- [deleteChunk](layer._internal_.FragmentSource.md#deletechunk)
- [dispose](layer._internal_.FragmentSource.md#dispose)
- [disposed](layer._internal_.FragmentSource.md#disposed)
- [getChunk](layer._internal_.FragmentSource.md#getchunk)
- [initializeCounterpart](layer._internal_.FragmentSource.md#initializecounterpart)
- [initializeSharedObject](layer._internal_.FragmentSource.md#initializesharedobject)
- [invalidateCache](layer._internal_.FragmentSource.md#invalidatecache)
- [ownerDispose](layer._internal_.FragmentSource.md#ownerdispose)
- [refCountReachedZero](layer._internal_.FragmentSource.md#refcountreachedzero)
- [registerCancellable](layer._internal_.FragmentSource.md#registercancellable)
- [registerDisposer](layer._internal_.FragmentSource.md#registerdisposer)
- [registerEventListener](layer._internal_.FragmentSource.md#registereventlistener)
- [unregisterDisposer](layer._internal_.FragmentSource.md#unregisterdisposer)
- [encodeOptions](layer._internal_.FragmentSource.md#encodeoptions)
...
| `meshSource` | [`MeshSource`](layer._internal_.MeshSource.md) |
...
[src/neuroglancer/mesh/frontend.ts:490](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L490)
...
• **chunks**: `Map`<`string`, [`FragmentChunk`](layer._internal_.FragmentChunk.md)\>
...
[src/neuroglancer/mesh/frontend.ts:486](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L486)
...
[src/neuroglancer/mesh/frontend.ts:487](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L487)
...
▸ **addRef**(): [`FragmentSource`](layer._internal_.FragmentSource.md)
...
▸ **getChunk**(`x`): [`FragmentChunk`](layer._internal_.FragmentChunk.md)
...
[src/neuroglancer/mesh/frontend.ts:493](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L493)
