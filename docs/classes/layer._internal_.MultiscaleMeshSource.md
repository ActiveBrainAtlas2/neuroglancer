[neuroglancer](../README.md) / [Modules](../modules.md) / [layer](../modules/layer.md) / [<internal\>](../modules/layer._internal_.md) / MultiscaleMeshSource

# Class: MultiscaleMeshSource

[layer](../modules/layer.md).[<internal>](../modules/layer._internal_.md).MultiscaleMeshSource
...
- [constructor](layer._internal_.MultiscaleMeshSource.md#constructor)

### Properties

- [OPTIONS](layer._internal_.MultiscaleMeshSource.md#options)
- [RPC\_TYPE\_ID](layer._internal_.MultiscaleMeshSource.md#rpc_type_id)
- [chunkManager](layer._internal_.MultiscaleMeshSource.md#chunkmanager)
- [chunks](layer._internal_.MultiscaleMeshSource.md#chunks)
- [disposedStacks](layer._internal_.MultiscaleMeshSource.md#disposedstacks)
- [format](layer._internal_.MultiscaleMeshSource.md#format)
- [fragmentSource](layer._internal_.MultiscaleMeshSource.md#fragmentsource)
- [immediateChunkUpdates](layer._internal_.MultiscaleMeshSource.md#immediatechunkupdates)
- [isOwner](layer._internal_.MultiscaleMeshSource.md#isowner)
- [key](layer._internal_.MultiscaleMeshSource.md#key)
- [refCount](layer._internal_.MultiscaleMeshSource.md#refcount)
- [referencedGeneration](layer._internal_.MultiscaleMeshSource.md#referencedgeneration)
- [rpc](layer._internal_.MultiscaleMeshSource.md#rpc)
- [rpcId](layer._internal_.MultiscaleMeshSource.md#rpcid)
- [unreferencedGeneration](layer._internal_.MultiscaleMeshSource.md#unreferencedgeneration)
- [wasDisposed](layer._internal_.MultiscaleMeshSource.md#wasdisposed)

### Accessors

- [gl](layer._internal_.MultiscaleMeshSource.md#gl)

### Methods

- [addChunk](layer._internal_.MultiscaleMeshSource.md#addchunk)
- [addCounterpartRef](layer._internal_.MultiscaleMeshSource.md#addcounterpartref)
- [addRef](layer._internal_.MultiscaleMeshSource.md#addref)
- [counterpartRefCountReachedZero](layer._internal_.MultiscaleMeshSource.md#counterpartrefcountreachedzero)
- [deleteChunk](layer._internal_.MultiscaleMeshSource.md#deletechunk)
- [dispose](layer._internal_.MultiscaleMeshSource.md#dispose)
- [disposed](layer._internal_.MultiscaleMeshSource.md#disposed)
- [getChunk](layer._internal_.MultiscaleMeshSource.md#getchunk)
- [initializeCounterpart](layer._internal_.MultiscaleMeshSource.md#initializecounterpart)
- [initializeSharedObject](layer._internal_.MultiscaleMeshSource.md#initializesharedobject)
- [invalidateCache](layer._internal_.MultiscaleMeshSource.md#invalidatecache)
- [ownerDispose](layer._internal_.MultiscaleMeshSource.md#ownerdispose)
- [refCountReachedZero](layer._internal_.MultiscaleMeshSource.md#refcountreachedzero)
- [registerCancellable](layer._internal_.MultiscaleMeshSource.md#registercancellable)
- [registerDisposer](layer._internal_.MultiscaleMeshSource.md#registerdisposer)
- [registerEventListener](layer._internal_.MultiscaleMeshSource.md#registereventlistener)
- [unregisterDisposer](layer._internal_.MultiscaleMeshSource.md#unregisterdisposer)
- [encodeOptions](layer._internal_.MultiscaleMeshSource.md#encodeoptions)
...
| `options` | [`MultiscaleMeshSourceOptions`](../interfaces/layer._internal_.MultiscaleMeshSourceOptions.md) |
...
[src/neuroglancer/mesh/frontend.ts:788](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L788)
...
[src/neuroglancer/mesh/frontend.ts:784](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L784)
...
• **chunks**: `Map`<`string`, [`MultiscaleManifestChunk`](layer._internal_.MultiscaleManifestChunk.md)\>
...
[src/neuroglancer/mesh/frontend.ts:786](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L786)
...
• **format**: [`MultiscaleFragmentFormat`](../interfaces/layer._internal_.MultiscaleFragmentFormat.md)

#### Defined in

[src/neuroglancer/mesh/frontend.ts:787](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L787)

___

### fragmentSource

• **fragmentSource**: [`MultiscaleFragmentSource`](layer._internal_.MultiscaleFragmentSource.md)

#### Defined in

[src/neuroglancer/mesh/frontend.ts:785](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L785)
...
▸ **addRef**(): [`MultiscaleMeshSource`](layer._internal_.MultiscaleMeshSource.md)
...
▸ **getChunk**(`x`): [`MultiscaleManifestChunk`](layer._internal_.MultiscaleManifestChunk.md)
...
[src/neuroglancer/mesh/frontend.ts:803](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L803)
...
[src/neuroglancer/mesh/frontend.ts:797](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L797)
...
[src/neuroglancer/mesh/frontend.ts:793](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/mesh/frontend.ts#L793)
