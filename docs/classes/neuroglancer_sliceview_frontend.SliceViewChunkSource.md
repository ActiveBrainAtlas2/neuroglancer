[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/sliceview/frontend](../modules/neuroglancer_sliceview_frontend.md) / SliceViewChunkSource

# Class: SliceViewChunkSource<Spec, ChunkType\>

[neuroglancer/sliceview/frontend](../modules/neuroglancer_sliceview_frontend.md).SliceViewChunkSource
...
| `ChunkType` | extends [`SliceViewChunk`](neuroglancer_sliceview_frontend.SliceViewChunk.md) = [`SliceViewChunk`](neuroglancer_sliceview_frontend.SliceViewChunk.md) |
...
- [constructor](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#constructor)

### Properties

- [OPTIONS](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#options)
- [RPC\_TYPE\_ID](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#rpc_type_id)
- [chunkManager](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#chunkmanager)
- [chunks](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#chunks)
- [disposedStacks](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#disposedstacks)
- [immediateChunkUpdates](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#immediatechunkupdates)
- [isOwner](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#isowner)
- [key](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#key)
- [refCount](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#refcount)
- [referencedGeneration](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#referencedgeneration)
- [rpc](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#rpc)
- [rpcId](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#rpcid)
- [spec](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#spec)
- [unreferencedGeneration](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#unreferencedgeneration)
- [wasDisposed](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#wasdisposed)

### Accessors

- [gl](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#gl)

### Methods

- [addChunk](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#addchunk)
- [addCounterpartRef](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#addcounterpartref)
- [addRef](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#addref)
- [counterpartRefCountReachedZero](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#counterpartrefcountreachedzero)
- [deleteChunk](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#deletechunk)
- [dispose](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#dispose)
- [disposed](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#disposed)
- [getChunk](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#getchunk)
- [initializeCounterpart](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#initializecounterpart)
- [initializeSharedObject](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#initializesharedobject)
- [invalidateCache](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#invalidatecache)
- [ownerDispose](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#ownerdispose)
- [refCountReachedZero](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#refcountreachedzero)
- [registerCancellable](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#registercancellable)
- [registerDisposer](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#registerdisposer)
- [registerEventListener](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#registereventlistener)
- [unregisterDisposer](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#unregisterdisposer)
- [encodeOptions](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#encodeoptions)
- [encodeSpec](neuroglancer_sliceview_frontend.SliceViewChunkSource.md#encodespec)
...
| `ChunkType` | extends [`SliceViewChunk`](neuroglancer_sliceview_frontend.SliceViewChunk.md)<`ChunkType`\> = [`SliceViewChunk`](neuroglancer_sliceview_frontend.SliceViewChunk.md) |
...
| `options` | [`SliceViewChunkSourceOptions`](../interfaces/neuroglancer_sliceview_frontend.SliceViewChunkSourceOptions.md)<`Spec`\> |
...
[src/neuroglancer/sliceview/frontend.ts:457](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/sliceview/frontend.ts#L457)
...
▸ **addRef**(): [`SliceViewChunkSource`](neuroglancer_sliceview_frontend.SliceViewChunkSource.md)<`Spec`, `ChunkType`\>

#### Returns

[`SliceViewChunkSource`](neuroglancer_sliceview_frontend.SliceViewChunkSource.md)<`Spec`, `ChunkType`\>
...
[SliceViewChunkSource](../interfaces/neuroglancer_sliceview_base.SliceViewChunkSource.md).[dispose](../interfaces/neuroglancer_sliceview_base.SliceViewChunkSource.md#dispose)
...
[src/neuroglancer/sliceview/frontend.ts:485](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/sliceview/frontend.ts#L485)
...
[src/neuroglancer/sliceview/frontend.ts:462](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/sliceview/frontend.ts#L462)
