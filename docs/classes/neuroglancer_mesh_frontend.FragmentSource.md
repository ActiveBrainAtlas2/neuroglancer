[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/mesh/frontend](../modules/neuroglancer_mesh_frontend.md) / FragmentSource

# Class: FragmentSource

[neuroglancer/mesh/frontend](../modules/neuroglancer_mesh_frontend.md).FragmentSource
...
- [constructor](neuroglancer_mesh_frontend.FragmentSource.md#constructor)

### Properties

- [OPTIONS](neuroglancer_mesh_frontend.FragmentSource.md#options)
- [RPC\_TYPE\_ID](neuroglancer_mesh_frontend.FragmentSource.md#rpc_type_id)
- [chunkManager](neuroglancer_mesh_frontend.FragmentSource.md#chunkmanager)
- [chunks](neuroglancer_mesh_frontend.FragmentSource.md#chunks)
- [disposedStacks](neuroglancer_mesh_frontend.FragmentSource.md#disposedstacks)
- [immediateChunkUpdates](neuroglancer_mesh_frontend.FragmentSource.md#immediatechunkupdates)
- [isOwner](neuroglancer_mesh_frontend.FragmentSource.md#isowner)
- [meshSource](neuroglancer_mesh_frontend.FragmentSource.md#meshsource)
- [refCount](neuroglancer_mesh_frontend.FragmentSource.md#refcount)
- [referencedGeneration](neuroglancer_mesh_frontend.FragmentSource.md#referencedgeneration)
- [rpc](neuroglancer_mesh_frontend.FragmentSource.md#rpc)
- [rpcId](neuroglancer_mesh_frontend.FragmentSource.md#rpcid)
- [unreferencedGeneration](neuroglancer_mesh_frontend.FragmentSource.md#unreferencedgeneration)
- [wasDisposed](neuroglancer_mesh_frontend.FragmentSource.md#wasdisposed)

### Accessors

- [gl](neuroglancer_mesh_frontend.FragmentSource.md#gl)
- [key](neuroglancer_mesh_frontend.FragmentSource.md#key)

### Methods

- [addChunk](neuroglancer_mesh_frontend.FragmentSource.md#addchunk)
- [addCounterpartRef](neuroglancer_mesh_frontend.FragmentSource.md#addcounterpartref)
- [addRef](neuroglancer_mesh_frontend.FragmentSource.md#addref)
- [counterpartRefCountReachedZero](neuroglancer_mesh_frontend.FragmentSource.md#counterpartrefcountreachedzero)
- [deleteChunk](neuroglancer_mesh_frontend.FragmentSource.md#deletechunk)
- [dispose](neuroglancer_mesh_frontend.FragmentSource.md#dispose)
- [disposed](neuroglancer_mesh_frontend.FragmentSource.md#disposed)
- [getChunk](neuroglancer_mesh_frontend.FragmentSource.md#getchunk)
- [initializeCounterpart](neuroglancer_mesh_frontend.FragmentSource.md#initializecounterpart)
- [initializeSharedObject](neuroglancer_mesh_frontend.FragmentSource.md#initializesharedobject)
- [invalidateCache](neuroglancer_mesh_frontend.FragmentSource.md#invalidatecache)
- [ownerDispose](neuroglancer_mesh_frontend.FragmentSource.md#ownerdispose)
- [refCountReachedZero](neuroglancer_mesh_frontend.FragmentSource.md#refcountreachedzero)
- [registerCancellable](neuroglancer_mesh_frontend.FragmentSource.md#registercancellable)
- [registerDisposer](neuroglancer_mesh_frontend.FragmentSource.md#registerdisposer)
- [registerEventListener](neuroglancer_mesh_frontend.FragmentSource.md#registereventlistener)
- [unregisterDisposer](neuroglancer_mesh_frontend.FragmentSource.md#unregisterdisposer)
- [encodeOptions](neuroglancer_mesh_frontend.FragmentSource.md#encodeoptions)
...
| `meshSource` | [`MeshSource`](neuroglancer_mesh_frontend.MeshSource.md) |
...
[src/neuroglancer/mesh/frontend.ts:490](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/mesh/frontend.ts#L490)
...
• **chunks**: `Map`<`string`, [`FragmentChunk`](neuroglancer_mesh_frontend.FragmentChunk.md)\>
...
[src/neuroglancer/mesh/frontend.ts:486](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/mesh/frontend.ts#L486)
...
[src/neuroglancer/mesh/frontend.ts:487](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/mesh/frontend.ts#L487)
...
▸ **addRef**(): [`FragmentSource`](neuroglancer_mesh_frontend.FragmentSource.md)
...
▸ **getChunk**(`x`): [`FragmentChunk`](neuroglancer_mesh_frontend.FragmentChunk.md)
...
[src/neuroglancer/mesh/frontend.ts:493](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/mesh/frontend.ts#L493)
