[neuroglancer](../README.md) / [Modules](../modules.md) / [renderlayer](../modules/renderlayer.md) / SharedProjectionParameters
...
[src/neuroglancer/renderlayer.ts:195](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/renderlayer.ts#L195)
...
• **base**: [`WatchableValueChangeInterface`](../interfaces/trackable_value.WatchableValueChangeInterface.md)<`T`\>
...
[src/neuroglancer/renderlayer.ts:194](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/renderlayer.ts#L194)
...
• `Private` **update**: [`DebouncedFunc`](../interfaces/data_panel_layout._internal_.DebouncedFunc.md)<(`_oldValue`: `T`, `newValue`: `T`) => `void`\>

#### Defined in

[src/neuroglancer/renderlayer.ts:206](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/renderlayer.ts#L206)
...
[src/neuroglancer/renderlayer.ts:202](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/540617bc/src/neuroglancer/renderlayer.ts#L202)
