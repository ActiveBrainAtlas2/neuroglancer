[neuroglancer](../README.md) / [Modules](../modules.md) / [mesh/frontend](../modules/mesh_frontend.md) / MeshSource

# Class: MeshSource

[mesh/frontend](../modules/mesh_frontend.md).MeshSource
...
- [constructor](mesh_frontend.MeshSource.md#constructor)

### Properties

- [OPTIONS](mesh_frontend.MeshSource.md#options)
- [RPC\_TYPE\_ID](mesh_frontend.MeshSource.md#rpc_type_id)
- [chunkManager](mesh_frontend.MeshSource.md#chunkmanager)
- [chunks](mesh_frontend.MeshSource.md#chunks)
- [disposedStacks](mesh_frontend.MeshSource.md#disposedstacks)
- [fragmentSource](mesh_frontend.MeshSource.md#fragmentsource)
- [immediateChunkUpdates](mesh_frontend.MeshSource.md#immediatechunkupdates)
- [isOwner](mesh_frontend.MeshSource.md#isowner)
- [key](mesh_frontend.MeshSource.md#key)
- [refCount](mesh_frontend.MeshSource.md#refcount)
- [referencedGeneration](mesh_frontend.MeshSource.md#referencedgeneration)
- [rpc](mesh_frontend.MeshSource.md#rpc)
- [rpcId](mesh_frontend.MeshSource.md#rpcid)
- [unreferencedGeneration](mesh_frontend.MeshSource.md#unreferencedgeneration)
- [wasDisposed](mesh_frontend.MeshSource.md#wasdisposed)

### Accessors

- [gl](mesh_frontend.MeshSource.md#gl)

### Methods

- [addChunk](mesh_frontend.MeshSource.md#addchunk)
- [addCounterpartRef](mesh_frontend.MeshSource.md#addcounterpartref)
- [addRef](mesh_frontend.MeshSource.md#addref)
- [counterpartRefCountReachedZero](mesh_frontend.MeshSource.md#counterpartrefcountreachedzero)
- [deleteChunk](mesh_frontend.MeshSource.md#deletechunk)
- [dispose](mesh_frontend.MeshSource.md#dispose)
- [disposed](mesh_frontend.MeshSource.md#disposed)
- [getChunk](mesh_frontend.MeshSource.md#getchunk)
- [initializeCounterpart](mesh_frontend.MeshSource.md#initializecounterpart)
- [initializeSharedObject](mesh_frontend.MeshSource.md#initializesharedobject)
- [invalidateCache](mesh_frontend.MeshSource.md#invalidatecache)
- [ownerDispose](mesh_frontend.MeshSource.md#ownerdispose)
- [refCountReachedZero](mesh_frontend.MeshSource.md#refcountreachedzero)
- [registerCancellable](mesh_frontend.MeshSource.md#registercancellable)
- [registerDisposer](mesh_frontend.MeshSource.md#registerdisposer)
- [registerEventListener](mesh_frontend.MeshSource.md#registereventlistener)
- [unregisterDisposer](mesh_frontend.MeshSource.md#unregisterdisposer)
- [encodeOptions](mesh_frontend.MeshSource.md#encodeoptions)
...
| `options` | [`MeshSourceOptions`](../interfaces/mesh_frontend.MeshSourceOptions.md) |
...
[src/neuroglancer/mesh/frontend.ts:470](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/frontend.ts#L470)
...
• **chunks**: `Map`<`string`, [`ManifestChunk`](mesh_frontend.ManifestChunk.md)\>
...
[src/neuroglancer/mesh/frontend.ts:468](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/frontend.ts#L468)
...
• **fragmentSource**: [`FragmentSource`](mesh_frontend.FragmentSource.md)

#### Defined in

[src/neuroglancer/mesh/frontend.ts:467](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/frontend.ts#L467)
...
▸ **addRef**(): [`MeshSource`](mesh_frontend.MeshSource.md)
...
▸ **getChunk**(`x`): [`ManifestChunk`](mesh_frontend.ManifestChunk.md)
...
[src/neuroglancer/mesh/frontend.ts:479](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/frontend.ts#L479)
...
[src/neuroglancer/mesh/frontend.ts:474](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/frontend.ts#L474)
