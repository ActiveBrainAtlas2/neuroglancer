[neuroglancer](../README.md) / [Modules](../modules.md) / [mesh/backend](../modules/mesh_backend.md) / FragmentChunk

# Class: FragmentChunk

[mesh/backend](../modules/mesh_backend.md).FragmentChunk
...
- [constructor](mesh_backend.FragmentChunk.md#constructor)

### Properties

- [backendOnly](mesh_backend.FragmentChunk.md#backendonly)
- [child0](mesh_backend.FragmentChunk.md#child0)
- [child1](mesh_backend.FragmentChunk.md#child1)
- [downloadCancellationToken](mesh_backend.FragmentChunk.md#downloadcancellationtoken)
- [error](mesh_backend.FragmentChunk.md#error)
- [fragmentId](mesh_backend.FragmentChunk.md#fragmentid)
- [isComputational](mesh_backend.FragmentChunk.md#iscomputational)
- [key](mesh_backend.FragmentChunk.md#key)
- [manifestChunk](mesh_backend.FragmentChunk.md#manifestchunk)
- [markGeneration](mesh_backend.FragmentChunk.md#markgeneration)
- [meshData](mesh_backend.FragmentChunk.md#meshdata)
- [newPriority](mesh_backend.FragmentChunk.md#newpriority)
- [newPriorityTier](mesh_backend.FragmentChunk.md#newprioritytier)
- [newlyRequestedToFrontend](mesh_backend.FragmentChunk.md#newlyrequestedtofrontend)
- [next0](mesh_backend.FragmentChunk.md#next0)
- [next1](mesh_backend.FragmentChunk.md#next1)
- [prev0](mesh_backend.FragmentChunk.md#prev0)
- [prev1](mesh_backend.FragmentChunk.md#prev1)
- [priority](mesh_backend.FragmentChunk.md#priority)
- [priorityTier](mesh_backend.FragmentChunk.md#prioritytier)
- [requestedToFrontend](mesh_backend.FragmentChunk.md#requestedtofrontend)
- [source](mesh_backend.FragmentChunk.md#source)

### Accessors

- [chunkManager](mesh_backend.FragmentChunk.md#chunkmanager)
- [downloadSlots](mesh_backend.FragmentChunk.md#downloadslots)
- [gpuMemoryBytes](mesh_backend.FragmentChunk.md#gpumemorybytes)
- [queueManager](mesh_backend.FragmentChunk.md#queuemanager)
- [state](mesh_backend.FragmentChunk.md#state)
- [systemMemoryBytes](mesh_backend.FragmentChunk.md#systemmemorybytes)

### Methods

- [dispose](mesh_backend.FragmentChunk.md#dispose)
- [downloadFailed](mesh_backend.FragmentChunk.md#downloadfailed)
- [downloadSucceeded](mesh_backend.FragmentChunk.md#downloadsucceeded)
- [freeSystemMemory](mesh_backend.FragmentChunk.md#freesystemmemory)
- [initialize](mesh_backend.FragmentChunk.md#initialize)
- [initializeFragmentChunk](mesh_backend.FragmentChunk.md#initializefragmentchunk)
- [registerListener](mesh_backend.FragmentChunk.md#registerlistener)
- [serialize](mesh_backend.FragmentChunk.md#serialize)
- [toString](mesh_backend.FragmentChunk.md#tostring)
- [unregisterListener](mesh_backend.FragmentChunk.md#unregisterlistener)
- [updatePriorityProperties](mesh_backend.FragmentChunk.md#updatepriorityproperties)
- [priorityGreater](mesh_backend.FragmentChunk.md#prioritygreater)
- [priorityLess](mesh_backend.FragmentChunk.md#priorityless)
...
[src/neuroglancer/mesh/backend.ts:121](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L121)
...
[src/neuroglancer/mesh/backend.ts:119](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L119)
...
• **manifestChunk**: ``null`` \| [`ManifestChunk`](mesh_backend.ManifestChunk.md) = `null`

#### Defined in

[src/neuroglancer/mesh/backend.ts:118](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L118)
...
[src/neuroglancer/mesh/backend.ts:120](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L120)
...
[src/neuroglancer/mesh/backend.ts:139](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L139)
...
[src/neuroglancer/mesh/backend.ts:129](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L129)
...
[src/neuroglancer/mesh/backend.ts:124](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L124)
...
[src/neuroglancer/mesh/backend.ts:134](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L134)
