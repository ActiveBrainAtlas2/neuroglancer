[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/datasource/zarr/backend](../modules/neuroglancer_datasource_zarr_backend.md) / PrecomputedVolumeChunkSource

# Class: PrecomputedVolumeChunkSource

[neuroglancer/datasource/zarr/backend](../modules/neuroglancer_datasource_zarr_backend.md).PrecomputedVolumeChunkSource

## Hierarchy

- `C`<[`VolumeChunkSourceParameters`](neuroglancer_datasource_zarr_base.VolumeChunkSourceParameters.md), { `prototype`: `__class`<`any`, `any`\>  } & typeof [`VolumeChunkSource`](neuroglancer_sliceview_volume_backend.VolumeChunkSource.md), `this`\> & `__class`<`any`, typeof [`VolumeChunkSource`](neuroglancer_sliceview_volume_backend.VolumeChunkSource.md), `this`\> & [`VolumeChunkSource`](neuroglancer_sliceview_volume_backend.VolumeChunkSource.md)<`this`\>
...
- [constructor](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#constructor)

### Properties

- [RPC\_TYPE\_ID](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#rpc_type_id)
- [chunkConstructor](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#chunkconstructor)
- [chunkManager](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#chunkmanager)
- [chunks](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#chunks)
- [credentialsProvider](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#credentialsprovider)
- [disposedStacks](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#disposedstacks)
- [freeChunks](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#freechunks)
- [isOwner](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#isowner)
- [parameters](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#parameters)
- [refCount](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#refcount)
- [referencedGeneration](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#referencedgeneration)
- [rpc](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#rpc)
- [rpcId](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#rpcid)
- [sourceQueueLevel](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#sourcequeuelevel)
- [spec](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#spec)
- [statistics](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#statistics)
- [unreferencedGeneration](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#unreferencedgeneration)
- [wasDisposed](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#wasdisposed)

### Methods

- [addChunk](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#addchunk)
- [addCounterpartRef](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#addcounterpartref)
- [addRef](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#addref)
- [chunkStateChanged](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#chunkstatechanged)
- [computeChunkBounds](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#computechunkbounds)
- [counterpartRefCountReachedZero](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#counterpartrefcountreachedzero)
- [dispose](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#dispose)
- [disposed](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#disposed)
- [download](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#download)
- [getChunk](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#getchunk)
- [getNewChunk\_](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#getnewchunk_)
- [initializeCounterpart](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#initializecounterpart)
- [initializeSharedObject](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#initializesharedobject)
- [ownerDispose](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#ownerdispose)
- [refCountReachedZero](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#refcountreachedzero)
- [registerCancellable](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#registercancellable)
- [registerChunkListener](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#registerchunklistener)
- [registerDisposer](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#registerdisposer)
- [registerEventListener](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#registereventlistener)
- [removeChunk](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#removechunk)
- [unregisterChunkListener](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#unregisterchunklistener)
- [unregisterDisposer](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md#unregisterdisposer)
...
• **parameters**: [`VolumeChunkSourceParameters`](neuroglancer_datasource_zarr_base.VolumeChunkSourceParameters.md)
...
▸ **addRef**(): [`PrecomputedVolumeChunkSource`](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md)

#### Returns

[`PrecomputedVolumeChunkSource`](neuroglancer_datasource_zarr_backend.PrecomputedVolumeChunkSource.md)
...
[src/neuroglancer/datasource/zarr/backend.ts:51](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/zarr/backend.ts#L51)
