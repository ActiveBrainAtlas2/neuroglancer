[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/mesh/backend](../modules/neuroglancer_mesh_backend.md) / MultiscaleFragmentChunk

# Class: MultiscaleFragmentChunk

[neuroglancer/mesh/backend](../modules/neuroglancer_mesh_backend.md).MultiscaleFragmentChunk
...
- [constructor](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#constructor)

### Properties

- [backendOnly](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#backendonly)
- [child0](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#child0)
- [child1](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#child1)
- [chunkIndex](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#chunkindex)
- [downloadCancellationToken](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#downloadcancellationtoken)
- [error](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#error)
- [isComputational](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#iscomputational)
- [key](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#key)
- [lod](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#lod)
- [manifestChunk](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#manifestchunk)
- [markGeneration](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#markgeneration)
- [meshData](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#meshdata)
- [newPriority](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#newpriority)
- [newPriorityTier](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#newprioritytier)
- [newlyRequestedToFrontend](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#newlyrequestedtofrontend)
- [next0](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#next0)
- [next1](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#next1)
- [prev0](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#prev0)
- [prev1](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#prev1)
- [priority](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#priority)
- [priorityTier](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#prioritytier)
- [requestedToFrontend](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#requestedtofrontend)
- [source](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#source)
- [subChunkOffsets](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#subchunkoffsets)

### Accessors

- [chunkManager](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#chunkmanager)
- [downloadSlots](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#downloadslots)
- [gpuMemoryBytes](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#gpumemorybytes)
- [queueManager](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#queuemanager)
- [state](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#state)
- [systemMemoryBytes](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#systemmemorybytes)

### Methods

- [dispose](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#dispose)
- [downloadFailed](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#downloadfailed)
- [downloadSucceeded](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#downloadsucceeded)
- [freeSystemMemory](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#freesystemmemory)
- [initialize](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#initialize)
- [registerListener](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#registerlistener)
- [serialize](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#serialize)
- [toString](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#tostring)
- [unregisterListener](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#unregisterlistener)
- [updatePriorityProperties](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#updatepriorityproperties)
- [priorityGreater](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#prioritygreater)
- [priorityLess](neuroglancer_mesh_backend.MultiscaleFragmentChunk.md#priorityless)
...
[src/neuroglancer/mesh/backend.ts:448](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L448)
...
[src/neuroglancer/mesh/backend.ts:446](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L446)
...
[src/neuroglancer/mesh/backend.ts:445](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L445)

___

### manifestChunk

• **manifestChunk**: ``null`` \| [`MultiscaleManifestChunk`](neuroglancer_mesh_backend.MultiscaleManifestChunk.md) = `null`

#### Defined in

[src/neuroglancer/mesh/backend.ts:447](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L447)
...
[src/neuroglancer/mesh/backend.ts:444](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L444)
...
[src/neuroglancer/mesh/backend.ts:443](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L443)
...
[src/neuroglancer/mesh/backend.ts:462](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L462)
...
[src/neuroglancer/mesh/backend.ts:451](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L451)
...
[src/neuroglancer/mesh/backend.ts:454](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L454)
