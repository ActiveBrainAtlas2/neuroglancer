[neuroglancer](../README.md) / [Modules](../modules.md) / [chunk\_manager/generic\_file\_source](../modules/chunk_manager_generic_file_source.md) / [<internal\>](../modules/chunk_manager_generic_file_source._internal_.md) / GenericSharedDataChunk

# Class: GenericSharedDataChunk<Key, Data\>

[chunk_manager/generic_file_source](../modules/chunk_manager_generic_file_source.md).[<internal>](../modules/chunk_manager_generic_file_source._internal_.md).GenericSharedDataChunk
...
- [constructor](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#constructor)

### Properties

- [backendOnly](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#backendonly)
- [child0](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#child0)
- [child1](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#child1)
- [data](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#data)
- [decodedKey](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#decodedkey)
- [downloadCancellationToken](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#downloadcancellationtoken)
- [error](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#error)
- [isComputational](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#iscomputational)
- [key](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#key)
- [markGeneration](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#markgeneration)
- [newPriority](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#newpriority)
- [newPriorityTier](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#newprioritytier)
- [newlyRequestedToFrontend](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#newlyrequestedtofrontend)
- [next0](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#next0)
- [next1](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#next1)
- [prev0](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#prev0)
- [prev1](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#prev1)
- [priority](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#priority)
- [priorityTier](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#prioritytier)
- [requestedToFrontend](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#requestedtofrontend)
- [requesters](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#requesters)
- [source](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#source)

### Accessors

- [chunkManager](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#chunkmanager)
- [downloadSlots](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#downloadslots)
- [gpuMemoryBytes](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#gpumemorybytes)
- [queueManager](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#queuemanager)
- [state](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#state)
- [systemMemoryBytes](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#systemmemorybytes)

### Methods

- [dispose](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#dispose)
- [downloadFailed](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#downloadfailed)
- [downloadSucceeded](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#downloadsucceeded)
- [freeSystemMemory](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#freesystemmemory)
- [initialize](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#initialize)
- [registerListener](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#registerlistener)
- [serialize](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#serialize)
- [toString](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#tostring)
- [unregisterListener](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#unregisterlistener)
- [updatePriorityProperties](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#updatepriorityproperties)
- [priorityGreater](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#prioritygreater)
- [priorityLess](chunk_manager_generic_file_source._internal_.GenericSharedDataChunk.md#priorityless)
...
[src/neuroglancer/chunk_manager/generic_file_source.ts:45](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/chunk_manager/generic_file_source.ts#L45)
...
[src/neuroglancer/chunk_manager/generic_file_source.ts:43](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/chunk_manager/generic_file_source.ts#L43)
...
[src/neuroglancer/chunk_manager/generic_file_source.ts:42](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/chunk_manager/generic_file_source.ts#L42)
...
• `Optional` **requesters**: `Set`<[`FileDataRequester`](../interfaces/chunk_manager_generic_file_source._internal_.FileDataRequester.md)<`Data`\>\>

#### Defined in

[src/neuroglancer/chunk_manager/generic_file_source.ts:44](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/chunk_manager/generic_file_source.ts#L44)
...
[src/neuroglancer/chunk_manager/generic_file_source.ts:61](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/chunk_manager/generic_file_source.ts#L61)
...
[src/neuroglancer/chunk_manager/generic_file_source.ts:52](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/chunk_manager/generic_file_source.ts#L52)
...
[src/neuroglancer/chunk_manager/generic_file_source.ts:70](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/chunk_manager/generic_file_source.ts#L70)
...
[src/neuroglancer/chunk_manager/generic_file_source.ts:47](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/chunk_manager/generic_file_source.ts#L47)
