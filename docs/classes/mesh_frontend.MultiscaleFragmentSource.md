[neuroglancer](../README.md) / [Modules](../modules.md) / [mesh/frontend](../modules/mesh_frontend.md) / MultiscaleFragmentSource

# Class: MultiscaleFragmentSource

[mesh/frontend](../modules/mesh_frontend.md).MultiscaleFragmentSource
...
- [constructor](mesh_frontend.MultiscaleFragmentSource.md#constructor)

### Properties

- [OPTIONS](mesh_frontend.MultiscaleFragmentSource.md#options)
- [RPC\_TYPE\_ID](mesh_frontend.MultiscaleFragmentSource.md#rpc_type_id)
- [chunkManager](mesh_frontend.MultiscaleFragmentSource.md#chunkmanager)
- [chunks](mesh_frontend.MultiscaleFragmentSource.md#chunks)
- [disposedStacks](mesh_frontend.MultiscaleFragmentSource.md#disposedstacks)
- [immediateChunkUpdates](mesh_frontend.MultiscaleFragmentSource.md#immediatechunkupdates)
- [isOwner](mesh_frontend.MultiscaleFragmentSource.md#isowner)
- [meshSource](mesh_frontend.MultiscaleFragmentSource.md#meshsource)
- [refCount](mesh_frontend.MultiscaleFragmentSource.md#refcount)
- [referencedGeneration](mesh_frontend.MultiscaleFragmentSource.md#referencedgeneration)
- [rpc](mesh_frontend.MultiscaleFragmentSource.md#rpc)
- [rpcId](mesh_frontend.MultiscaleFragmentSource.md#rpcid)
- [unreferencedGeneration](mesh_frontend.MultiscaleFragmentSource.md#unreferencedgeneration)
- [wasDisposed](mesh_frontend.MultiscaleFragmentSource.md#wasdisposed)

### Accessors

- [gl](mesh_frontend.MultiscaleFragmentSource.md#gl)
- [key](mesh_frontend.MultiscaleFragmentSource.md#key)

### Methods

- [addChunk](mesh_frontend.MultiscaleFragmentSource.md#addchunk)
- [addCounterpartRef](mesh_frontend.MultiscaleFragmentSource.md#addcounterpartref)
- [addRef](mesh_frontend.MultiscaleFragmentSource.md#addref)
- [counterpartRefCountReachedZero](mesh_frontend.MultiscaleFragmentSource.md#counterpartrefcountreachedzero)
- [deleteChunk](mesh_frontend.MultiscaleFragmentSource.md#deletechunk)
- [dispose](mesh_frontend.MultiscaleFragmentSource.md#dispose)
- [disposed](mesh_frontend.MultiscaleFragmentSource.md#disposed)
- [getChunk](mesh_frontend.MultiscaleFragmentSource.md#getchunk)
- [initializeCounterpart](mesh_frontend.MultiscaleFragmentSource.md#initializecounterpart)
- [initializeSharedObject](mesh_frontend.MultiscaleFragmentSource.md#initializesharedobject)
- [invalidateCache](mesh_frontend.MultiscaleFragmentSource.md#invalidatecache)
- [ownerDispose](mesh_frontend.MultiscaleFragmentSource.md#ownerdispose)
- [refCountReachedZero](mesh_frontend.MultiscaleFragmentSource.md#refcountreachedzero)
- [registerCancellable](mesh_frontend.MultiscaleFragmentSource.md#registercancellable)
- [registerDisposer](mesh_frontend.MultiscaleFragmentSource.md#registerdisposer)
- [registerEventListener](mesh_frontend.MultiscaleFragmentSource.md#registereventlistener)
- [unregisterDisposer](mesh_frontend.MultiscaleFragmentSource.md#unregisterdisposer)
- [encodeOptions](mesh_frontend.MultiscaleFragmentSource.md#encodeoptions)
...
| `meshSource` | [`MultiscaleMeshSource`](mesh_frontend.MultiscaleMeshSource.md) |
...
[src/neuroglancer/mesh/frontend.ts:814](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/frontend.ts#L814)
...
• **chunks**: `Map`<`string`, [`MultiscaleFragmentChunk`](mesh_frontend.MultiscaleFragmentChunk.md)\>
...
[src/neuroglancer/mesh/frontend.ts:810](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/frontend.ts#L810)
...
[src/neuroglancer/mesh/frontend.ts:811](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/frontend.ts#L811)
...
▸ **addRef**(): [`MultiscaleFragmentSource`](mesh_frontend.MultiscaleFragmentSource.md)
...
▸ **getChunk**(`x`): [`MultiscaleFragmentChunk`](mesh_frontend.MultiscaleFragmentChunk.md)
...
[src/neuroglancer/mesh/frontend.ts:817](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/frontend.ts#L817)
