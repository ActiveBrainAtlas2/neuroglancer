[neuroglancer](../README.md) / [Modules](../modules.md) / [mesh/backend](../modules/mesh_backend.md) / MultiscaleFragmentChunk
...
• **manifestChunk**: ``null`` \| [`MultiscaleManifestChunk`](mesh_backend.MultiscaleManifestChunk.md) = `null`
