[neuroglancer](../README.md) / [Modules](../modules.md) / [mesh/backend](../modules/mesh_backend.md) / FragmentSource

# Class: FragmentSource

[mesh/backend](../modules/mesh_backend.md).FragmentSource
...
- [constructor](mesh_backend.FragmentSource.md#constructor)

### Properties

- [RPC\_TYPE\_ID](mesh_backend.FragmentSource.md#rpc_type_id)
- [chunkManager](mesh_backend.FragmentSource.md#chunkmanager)
- [chunks](mesh_backend.FragmentSource.md#chunks)
- [disposedStacks](mesh_backend.FragmentSource.md#disposedstacks)
- [freeChunks](mesh_backend.FragmentSource.md#freechunks)
- [isOwner](mesh_backend.FragmentSource.md#isowner)
- [meshSource](mesh_backend.FragmentSource.md#meshsource)
- [refCount](mesh_backend.FragmentSource.md#refcount)
- [referencedGeneration](mesh_backend.FragmentSource.md#referencedgeneration)
- [rpc](mesh_backend.FragmentSource.md#rpc)
- [rpcId](mesh_backend.FragmentSource.md#rpcid)
- [sourceQueueLevel](mesh_backend.FragmentSource.md#sourcequeuelevel)
- [statistics](mesh_backend.FragmentSource.md#statistics)
- [unreferencedGeneration](mesh_backend.FragmentSource.md#unreferencedgeneration)
- [wasDisposed](mesh_backend.FragmentSource.md#wasdisposed)

### Methods

- [addChunk](mesh_backend.FragmentSource.md#addchunk)
- [addCounterpartRef](mesh_backend.FragmentSource.md#addcounterpartref)
- [addRef](mesh_backend.FragmentSource.md#addref)
- [chunkStateChanged](mesh_backend.FragmentSource.md#chunkstatechanged)
- [counterpartRefCountReachedZero](mesh_backend.FragmentSource.md#counterpartrefcountreachedzero)
- [dispose](mesh_backend.FragmentSource.md#dispose)
- [disposed](mesh_backend.FragmentSource.md#disposed)
- [download](mesh_backend.FragmentSource.md#download)
- [getNewChunk\_](mesh_backend.FragmentSource.md#getnewchunk_)
- [initializeCounterpart](mesh_backend.FragmentSource.md#initializecounterpart)
- [initializeSharedObject](mesh_backend.FragmentSource.md#initializesharedobject)
- [ownerDispose](mesh_backend.FragmentSource.md#ownerdispose)
- [refCountReachedZero](mesh_backend.FragmentSource.md#refcountreachedzero)
- [registerCancellable](mesh_backend.FragmentSource.md#registercancellable)
- [registerChunkListener](mesh_backend.FragmentSource.md#registerchunklistener)
- [registerDisposer](mesh_backend.FragmentSource.md#registerdisposer)
- [registerEventListener](mesh_backend.FragmentSource.md#registereventlistener)
- [removeChunk](mesh_backend.FragmentSource.md#removechunk)
- [unregisterChunkListener](mesh_backend.FragmentSource.md#unregisterchunklistener)
- [unregisterDisposer](mesh_backend.FragmentSource.md#unregisterdisposer)
...
• **meshSource**: ``null`` \| [`MeshSource`](mesh_backend.MeshSource.md) = `null`

#### Defined in

[src/neuroglancer/mesh/backend.ts:339](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L339)
...
▸ **addRef**(): [`FragmentSource`](mesh_backend.FragmentSource.md)
...
[src/neuroglancer/mesh/backend.ts:340](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L340)
