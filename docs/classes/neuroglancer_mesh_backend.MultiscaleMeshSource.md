[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/mesh/backend](../modules/neuroglancer_mesh_backend.md) / MultiscaleMeshSource

# Class: MultiscaleMeshSource

[neuroglancer/mesh/backend](../modules/neuroglancer_mesh_backend.md).MultiscaleMeshSource
...
- [constructor](neuroglancer_mesh_backend.MultiscaleMeshSource.md#constructor)

### Properties

- [RPC\_TYPE\_ID](neuroglancer_mesh_backend.MultiscaleMeshSource.md#rpc_type_id)
- [chunkManager](neuroglancer_mesh_backend.MultiscaleMeshSource.md#chunkmanager)
- [chunks](neuroglancer_mesh_backend.MultiscaleMeshSource.md#chunks)
- [disposedStacks](neuroglancer_mesh_backend.MultiscaleMeshSource.md#disposedstacks)
- [format](neuroglancer_mesh_backend.MultiscaleMeshSource.md#format)
- [fragmentSource](neuroglancer_mesh_backend.MultiscaleMeshSource.md#fragmentsource)
- [freeChunks](neuroglancer_mesh_backend.MultiscaleMeshSource.md#freechunks)
- [isOwner](neuroglancer_mesh_backend.MultiscaleMeshSource.md#isowner)
- [refCount](neuroglancer_mesh_backend.MultiscaleMeshSource.md#refcount)
- [referencedGeneration](neuroglancer_mesh_backend.MultiscaleMeshSource.md#referencedgeneration)
- [rpc](neuroglancer_mesh_backend.MultiscaleMeshSource.md#rpc)
- [rpcId](neuroglancer_mesh_backend.MultiscaleMeshSource.md#rpcid)
- [sourceQueueLevel](neuroglancer_mesh_backend.MultiscaleMeshSource.md#sourcequeuelevel)
- [statistics](neuroglancer_mesh_backend.MultiscaleMeshSource.md#statistics)
- [unreferencedGeneration](neuroglancer_mesh_backend.MultiscaleMeshSource.md#unreferencedgeneration)
- [wasDisposed](neuroglancer_mesh_backend.MultiscaleMeshSource.md#wasdisposed)

### Methods

- [addChunk](neuroglancer_mesh_backend.MultiscaleMeshSource.md#addchunk)
- [addCounterpartRef](neuroglancer_mesh_backend.MultiscaleMeshSource.md#addcounterpartref)
- [addRef](neuroglancer_mesh_backend.MultiscaleMeshSource.md#addref)
- [chunkStateChanged](neuroglancer_mesh_backend.MultiscaleMeshSource.md#chunkstatechanged)
- [counterpartRefCountReachedZero](neuroglancer_mesh_backend.MultiscaleMeshSource.md#counterpartrefcountreachedzero)
- [dispose](neuroglancer_mesh_backend.MultiscaleMeshSource.md#dispose)
- [disposed](neuroglancer_mesh_backend.MultiscaleMeshSource.md#disposed)
- [download](neuroglancer_mesh_backend.MultiscaleMeshSource.md#download)
- [downloadFragment](neuroglancer_mesh_backend.MultiscaleMeshSource.md#downloadfragment)
- [getChunk](neuroglancer_mesh_backend.MultiscaleMeshSource.md#getchunk)
- [getFragmentChunk](neuroglancer_mesh_backend.MultiscaleMeshSource.md#getfragmentchunk)
- [getNewChunk\_](neuroglancer_mesh_backend.MultiscaleMeshSource.md#getnewchunk_)
- [initializeCounterpart](neuroglancer_mesh_backend.MultiscaleMeshSource.md#initializecounterpart)
- [initializeSharedObject](neuroglancer_mesh_backend.MultiscaleMeshSource.md#initializesharedobject)
- [ownerDispose](neuroglancer_mesh_backend.MultiscaleMeshSource.md#ownerdispose)
- [refCountReachedZero](neuroglancer_mesh_backend.MultiscaleMeshSource.md#refcountreachedzero)
- [registerCancellable](neuroglancer_mesh_backend.MultiscaleMeshSource.md#registercancellable)
- [registerChunkListener](neuroglancer_mesh_backend.MultiscaleMeshSource.md#registerchunklistener)
- [registerDisposer](neuroglancer_mesh_backend.MultiscaleMeshSource.md#registerdisposer)
- [registerEventListener](neuroglancer_mesh_backend.MultiscaleMeshSource.md#registereventlistener)
- [removeChunk](neuroglancer_mesh_backend.MultiscaleMeshSource.md#removechunk)
- [unregisterChunkListener](neuroglancer_mesh_backend.MultiscaleMeshSource.md#unregisterchunklistener)
- [unregisterDisposer](neuroglancer_mesh_backend.MultiscaleMeshSource.md#unregisterdisposer)

## Constructors

### constructor

• **new MultiscaleMeshSource**(`rpc`, `options`)
...
[src/neuroglancer/mesh/backend.ts:483](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L483)
...
[src/neuroglancer/mesh/backend.ts:481](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L481)
...
[src/neuroglancer/mesh/backend.ts:480](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L480)
...
▸ **addRef**(): [`MultiscaleMeshSource`](neuroglancer_mesh_backend.MultiscaleMeshSource.md)
...
[src/neuroglancer/mesh/backend.ts:475](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L475)
...
[src/neuroglancer/mesh/backend.ts:491](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L491)
...
[src/neuroglancer/mesh/backend.ts:502](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/mesh/backend.ts#L502)
