...
- `C`<[`SingleMeshSourceParametersWithInfo`](neuroglancer_single_mesh_base.SingleMeshSourceParametersWithInfo.md), (...`args`: `any`[]) => `__class`<`any`, typeof [`ChunkSource`](neuroglancer_chunk_manager_backend.ChunkSource.md)\> & typeof [`ChunkSource`](neuroglancer_chunk_manager_backend.ChunkSource.md), `this`\> & `__class`<`any`, typeof [`ChunkSource`](neuroglancer_chunk_manager_backend.ChunkSource.md), `this`\> & [`ChunkSource`](neuroglancer_chunk_manager_backend.ChunkSource.md)<`this`\>
...
[src/neuroglancer/single_mesh/backend.ts:147](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/single_mesh/backend.ts#L147)
...
[src/neuroglancer/single_mesh/backend.ts:136](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/single_mesh/backend.ts#L136)
