[neuroglancer](../README.md) / [Modules](../modules.md) / [mesh/backend](../modules/mesh_backend.md) / MultiscaleManifestChunk

# Class: MultiscaleManifestChunk

[mesh/backend](../modules/mesh_backend.md).MultiscaleManifestChunk
...
- [constructor](mesh_backend.MultiscaleManifestChunk.md#constructor)

### Properties

- [backendOnly](mesh_backend.MultiscaleManifestChunk.md#backendonly)
- [child0](mesh_backend.MultiscaleManifestChunk.md#child0)
- [child1](mesh_backend.MultiscaleManifestChunk.md#child1)
- [downloadCancellationToken](mesh_backend.MultiscaleManifestChunk.md#downloadcancellationtoken)
- [error](mesh_backend.MultiscaleManifestChunk.md#error)
- [isComputational](mesh_backend.MultiscaleManifestChunk.md#iscomputational)
- [key](mesh_backend.MultiscaleManifestChunk.md#key)
- [manifest](mesh_backend.MultiscaleManifestChunk.md#manifest)
- [markGeneration](mesh_backend.MultiscaleManifestChunk.md#markgeneration)
- [newPriority](mesh_backend.MultiscaleManifestChunk.md#newpriority)
- [newPriorityTier](mesh_backend.MultiscaleManifestChunk.md#newprioritytier)
- [newlyRequestedToFrontend](mesh_backend.MultiscaleManifestChunk.md#newlyrequestedtofrontend)
- [next0](mesh_backend.MultiscaleManifestChunk.md#next0)
- [next1](mesh_backend.MultiscaleManifestChunk.md#next1)
- [objectId](mesh_backend.MultiscaleManifestChunk.md#objectid)
- [prev0](mesh_backend.MultiscaleManifestChunk.md#prev0)
- [prev1](mesh_backend.MultiscaleManifestChunk.md#prev1)
- [priority](mesh_backend.MultiscaleManifestChunk.md#priority)
- [priorityTier](mesh_backend.MultiscaleManifestChunk.md#prioritytier)
- [requestedToFrontend](mesh_backend.MultiscaleManifestChunk.md#requestedtofrontend)
- [source](mesh_backend.MultiscaleManifestChunk.md#source)

### Accessors

- [chunkManager](mesh_backend.MultiscaleManifestChunk.md#chunkmanager)
- [downloadSlots](mesh_backend.MultiscaleManifestChunk.md#downloadslots)
- [gpuMemoryBytes](mesh_backend.MultiscaleManifestChunk.md#gpumemorybytes)
- [queueManager](mesh_backend.MultiscaleManifestChunk.md#queuemanager)
- [state](mesh_backend.MultiscaleManifestChunk.md#state)
- [systemMemoryBytes](mesh_backend.MultiscaleManifestChunk.md#systemmemorybytes)

### Methods

- [dispose](mesh_backend.MultiscaleManifestChunk.md#dispose)
- [downloadFailed](mesh_backend.MultiscaleManifestChunk.md#downloadfailed)
- [downloadSucceeded](mesh_backend.MultiscaleManifestChunk.md#downloadsucceeded)
- [freeSystemMemory](mesh_backend.MultiscaleManifestChunk.md#freesystemmemory)
- [initialize](mesh_backend.MultiscaleManifestChunk.md#initialize)
- [initializeManifestChunk](mesh_backend.MultiscaleManifestChunk.md#initializemanifestchunk)
- [registerListener](mesh_backend.MultiscaleManifestChunk.md#registerlistener)
- [serialize](mesh_backend.MultiscaleManifestChunk.md#serialize)
- [toString](mesh_backend.MultiscaleManifestChunk.md#tostring)
- [unregisterListener](mesh_backend.MultiscaleManifestChunk.md#unregisterlistener)
- [updatePriorityProperties](mesh_backend.MultiscaleManifestChunk.md#updatepriorityproperties)
- [priorityGreater](mesh_backend.MultiscaleManifestChunk.md#prioritygreater)
- [priorityLess](mesh_backend.MultiscaleManifestChunk.md#priorityless)

## Constructors

### constructor

• **new MultiscaleManifestChunk**()
...
[src/neuroglancer/mesh/backend.ts:406](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L406)
...
• **manifest**: `undefined` \| [`MultiscaleMeshManifest`](../interfaces/mesh_multiscale.MultiscaleMeshManifest.md)

#### Defined in

[src/neuroglancer/mesh/backend.ts:404](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L404)
...
[src/neuroglancer/mesh/backend.ts:403](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L403)
...
[src/neuroglancer/mesh/backend.ts:425](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L425)
...
[src/neuroglancer/mesh/backend.ts:416](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L416)
...
[src/neuroglancer/mesh/backend.ts:411](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L411)
...
[src/neuroglancer/mesh/backend.ts:420](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L420)
...
[src/neuroglancer/mesh/backend.ts:434](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L434)
