[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/datasource/dvid/frontend](../modules/neuroglancer_datasource_dvid_frontend.md) / DVIDDataSource

# Class: DVIDDataSource

[neuroglancer/datasource/dvid/frontend](../modules/neuroglancer_datasource_dvid_frontend.md).DVIDDataSource
...
- [constructor](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#constructor)

### Properties

- [credentialsManager](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#credentialsmanager)
- [disposedStacks](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#disposedstacks)
- [refCount](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#refcount)
- [wasDisposed](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#wasdisposed)

### Accessors

- [description](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#description)

### Methods

- [addRef](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#addref)
- [completeUrl](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#completeurl)
- [convertLegacyUrl](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#convertlegacyurl)
- [dispose](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#dispose)
- [disposed](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#disposed)
- [findSourceGroup](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#findsourcegroup)
- [get](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#get)
- [normalizeUrl](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#normalizeurl)
- [refCountReachedZero](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#refcountreachedzero)
- [registerCancellable](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#registercancellable)
- [registerDisposer](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#registerdisposer)
- [registerEventListener](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#registereventlistener)
- [suggestLayerName](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#suggestlayername)
- [unregisterDisposer](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md#unregisterdisposer)

## Constructors

### constructor

• **new DVIDDataSource**(`credentialsManager`)
...
[src/neuroglancer/datasource/dvid/frontend.ts:562](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/dvid/frontend.ts#L562)
...
[src/neuroglancer/datasource/dvid/frontend.ts:566](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/dvid/frontend.ts#L566)

## Methods

### addRef

▸ **addRef**(): [`DVIDDataSource`](neuroglancer_datasource_dvid_frontend.DVIDDataSource.md)
...
[src/neuroglancer/datasource/dvid/frontend.ts:574](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/dvid/frontend.ts#L574)
...
[src/neuroglancer/datasource/dvid/frontend.ts:570](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/dvid/frontend.ts#L570)
