[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/mesh/backend](../modules/neuroglancer_mesh_backend.md) / MultiscaleManifestChunk

# Class: MultiscaleManifestChunk

[neuroglancer/mesh/backend](../modules/neuroglancer_mesh_backend.md).MultiscaleManifestChunk
...
- [constructor](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#constructor)

### Properties

- [backendOnly](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#backendonly)
- [child0](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#child0)
- [child1](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#child1)
- [downloadCancellationToken](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#downloadcancellationtoken)
- [error](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#error)
- [isComputational](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#iscomputational)
- [key](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#key)
- [manifest](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#manifest)
- [markGeneration](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#markgeneration)
- [newPriority](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#newpriority)
- [newPriorityTier](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#newprioritytier)
- [newlyRequestedToFrontend](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#newlyrequestedtofrontend)
- [next0](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#next0)
- [next1](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#next1)
- [objectId](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#objectid)
- [prev0](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#prev0)
- [prev1](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#prev1)
- [priority](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#priority)
- [priorityTier](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#prioritytier)
- [requestedToFrontend](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#requestedtofrontend)
- [source](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#source)

### Accessors

- [chunkManager](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#chunkmanager)
- [downloadSlots](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#downloadslots)
- [gpuMemoryBytes](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#gpumemorybytes)
- [queueManager](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#queuemanager)
- [state](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#state)
- [systemMemoryBytes](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#systemmemorybytes)

### Methods

- [dispose](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#dispose)
- [downloadFailed](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#downloadfailed)
- [downloadSucceeded](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#downloadsucceeded)
- [freeSystemMemory](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#freesystemmemory)
- [initialize](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#initialize)
- [initializeManifestChunk](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#initializemanifestchunk)
- [registerListener](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#registerlistener)
- [serialize](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#serialize)
- [toString](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#tostring)
- [unregisterListener](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#unregisterlistener)
- [updatePriorityProperties](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#updatepriorityproperties)
- [priorityGreater](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#prioritygreater)
- [priorityLess](neuroglancer_mesh_backend.MultiscaleManifestChunk.md#priorityless)
...
[src/neuroglancer/mesh/backend.ts:406](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/mesh/backend.ts#L406)
...
• **manifest**: `undefined` \| [`MultiscaleMeshManifest`](../interfaces/neuroglancer_mesh_multiscale.MultiscaleMeshManifest.md)
