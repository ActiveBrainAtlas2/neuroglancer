...
- `C`<[`MultiscaleMeshSourceParameters`](neuroglancer_datasource_brainmaps_base.MultiscaleMeshSourceParameters.md), { `prototype`: `__class`<`any`, `any`\>  } & typeof [`MultiscaleMeshSource`](neuroglancer_mesh_backend.MultiscaleMeshSource.md), `this`\> & `__class`<[`OAuth2Credentials`](../interfaces/neuroglancer_credentials_provider_oauth2.OAuth2Credentials.md), typeof [`MultiscaleMeshSource`](neuroglancer_mesh_backend.MultiscaleMeshSource.md), `this`\> & [`MultiscaleMeshSource`](neuroglancer_mesh_backend.MultiscaleMeshSource.md)<`this`\>
...
[src/neuroglancer/datasource/brainmaps/backend.ts:383](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/brainmaps/backend.ts#L383)
...
[src/neuroglancer/datasource/brainmaps/backend.ts:392](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/brainmaps/backend.ts#L392)
...
[src/neuroglancer/datasource/brainmaps/backend.ts:407](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/brainmaps/backend.ts#L407)
