[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/datasource/vtk/frontend](../modules/neuroglancer_datasource_vtk_frontend.md) / VtkDataSource

# Class: VtkDataSource

[neuroglancer/datasource/vtk/frontend](../modules/neuroglancer_datasource_vtk_frontend.md).VtkDataSource
...
- [constructor](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#constructor)

### Properties

- [disposedStacks](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#disposedstacks)
- [refCount](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#refcount)
- [wasDisposed](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#wasdisposed)

### Accessors

- [description](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#description)

### Methods

- [addRef](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#addref)
- [completeUrl](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#completeurl)
- [convertLegacyUrl](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#convertlegacyurl)
- [dispose](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#dispose)
- [disposed](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#disposed)
- [findSourceGroup](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#findsourcegroup)
- [get](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#get)
- [normalizeUrl](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#normalizeurl)
- [refCountReachedZero](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#refcountreachedzero)
- [registerCancellable](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#registercancellable)
- [registerDisposer](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#registerdisposer)
- [registerEventListener](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#registereventlistener)
- [suggestLayerName](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#suggestlayername)
- [unregisterDisposer](neuroglancer_datasource_vtk_frontend.VtkDataSource.md#unregisterdisposer)
...
[src/neuroglancer/datasource/vtk/frontend.ts:23](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/vtk/frontend.ts#L23)

## Methods

### addRef

▸ **addRef**(): [`VtkDataSource`](neuroglancer_datasource_vtk_frontend.VtkDataSource.md)
...
[src/neuroglancer/datasource/vtk/frontend.ts:46](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/vtk/frontend.ts#L46)
...
[src/neuroglancer/datasource/vtk/frontend.ts:27](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/vtk/frontend.ts#L27)
