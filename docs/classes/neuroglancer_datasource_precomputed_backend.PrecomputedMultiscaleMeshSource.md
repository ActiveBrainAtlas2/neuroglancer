...
- `C`<[`MultiscaleMeshSourceParameters`](neuroglancer_datasource_precomputed_base.MultiscaleMeshSourceParameters.md), { `prototype`: `__class`<`any`, `any`\>  } & typeof [`MultiscaleMeshSource`](neuroglancer_mesh_backend.MultiscaleMeshSource.md), `this`\> & `__class`<`any`, typeof [`MultiscaleMeshSource`](neuroglancer_mesh_backend.MultiscaleMeshSource.md), `this`\> & [`MultiscaleMeshSource`](neuroglancer_mesh_backend.MultiscaleMeshSource.md)<`this`\>
...
[src/neuroglancer/datasource/precomputed/backend.ts:539](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/precomputed/backend.ts#L539)
...
[src/neuroglancer/datasource/precomputed/backend.ts:543](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/precomputed/backend.ts#L543)
...
[src/neuroglancer/datasource/precomputed/backend.ts:558](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/datasource/precomputed/backend.ts#L558)
