[neuroglancer](../README.md) / [Modules](../modules.md) / [annotation/backend](../modules/annotation_backend.md) / [<internal\>](../modules/annotation_backend._internal_.md) / AnnotationSubsetGeometryChunkSource

# Class: AnnotationSubsetGeometryChunkSource

[annotation/backend](../modules/annotation_backend.md).[<internal>](../modules/annotation_backend._internal_.md).AnnotationSubsetGeometryChunkSource
...
- [constructor](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#constructor)

### Properties

- [RPC\_TYPE\_ID](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#rpc_type_id)
- [chunkManager](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#chunkmanager)
- [chunks](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#chunks)
- [disposedStacks](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#disposedstacks)
- [freeChunks](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#freechunks)
- [isOwner](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#isowner)
- [parent](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#parent)
- [refCount](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#refcount)
- [referencedGeneration](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#referencedgeneration)
- [relationshipIndex](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#relationshipindex)
- [rpc](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#rpc)
- [rpcId](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#rpcid)
- [sourceQueueLevel](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#sourcequeuelevel)
- [statistics](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#statistics)
- [unreferencedGeneration](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#unreferencedgeneration)
- [wasDisposed](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#wasdisposed)

### Methods

- [addChunk](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#addchunk)
- [addCounterpartRef](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#addcounterpartref)
- [addRef](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#addref)
- [chunkStateChanged](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#chunkstatechanged)
- [counterpartRefCountReachedZero](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#counterpartrefcountreachedzero)
- [dispose](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#dispose)
- [disposed](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#disposed)
- [download](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#download)
- [getChunk](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#getchunk)
- [getNewChunk\_](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#getnewchunk_)
- [initializeCounterpart](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#initializecounterpart)
- [initializeSharedObject](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#initializesharedobject)
- [ownerDispose](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#ownerdispose)
- [refCountReachedZero](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#refcountreachedzero)
- [registerCancellable](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#registercancellable)
- [registerChunkListener](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#registerchunklistener)
- [registerDisposer](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#registerdisposer)
- [registerEventListener](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#registereventlistener)
- [removeChunk](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#removechunk)
- [unregisterChunkListener](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#unregisterchunklistener)
- [unregisterDisposer](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md#unregisterdisposer)
...
• **chunks**: `Map`<`string`, [`AnnotationSubsetGeometryChunk`](annotation_backend.AnnotationSubsetGeometryChunk.md)\>
...
[src/neuroglancer/annotation/backend.ts:141](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/annotation/backend.ts#L141)
...
[src/neuroglancer/annotation/backend.ts:140](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/annotation/backend.ts#L140)
...
[src/neuroglancer/annotation/backend.ts:142](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/annotation/backend.ts#L142)
...
▸ **addRef**(): [`AnnotationSubsetGeometryChunkSource`](annotation_backend._internal_.AnnotationSubsetGeometryChunkSource.md)
...
[src/neuroglancer/annotation/backend.ts:155](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/annotation/backend.ts#L155)

___

### getChunk

▸ **getChunk**(`objectId`): [`AnnotationSubsetGeometryChunk`](annotation_backend.AnnotationSubsetGeometryChunk.md)
...
[`AnnotationSubsetGeometryChunk`](annotation_backend.AnnotationSubsetGeometryChunk.md)

#### Defined in

[src/neuroglancer/annotation/backend.ts:143](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/annotation/backend.ts#L143)
