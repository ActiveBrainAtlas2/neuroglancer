[neuroglancer](../README.md) / [Modules](../modules.md) / [util/geom](../modules/util_geom.md) / mat2
...
▸ `Static` **set**(`out`, `m00`, `m01`, `m10`, `m11`): [`mat2`](util_geom.mat2.md)
