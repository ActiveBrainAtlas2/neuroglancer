[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/credentials\_provider/shared\_counterpart](../modules/neuroglancer_credentials_provider_shared_counterpart.md) / SharedCredentialsProviderCounterpart

# Class: SharedCredentialsProviderCounterpart<Credentials\>

[neuroglancer/credentials_provider/shared_counterpart](../modules/neuroglancer_credentials_provider_shared_counterpart.md).SharedCredentialsProviderCounterpart
...
- [constructor](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#constructor)

### Properties

- [RPC\_TYPE\_ID](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#rpc_type_id)
- [disposedStacks](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#disposedstacks)
- [get](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#get)
- [isOwner](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#isowner)
- [refCount](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#refcount)
- [referencedGeneration](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#referencedgeneration)
- [rpc](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#rpc)
- [rpcId](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#rpcid)
- [unreferencedGeneration](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#unreferencedgeneration)
- [wasDisposed](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#wasdisposed)

### Methods

- [addCounterpartRef](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#addcounterpartref)
- [addRef](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#addref)
- [counterpartRefCountReachedZero](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#counterpartrefcountreachedzero)
- [dispose](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#dispose)
- [disposed](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#disposed)
- [initializeCounterpart](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#initializecounterpart)
- [initializeSharedObject](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#initializesharedobject)
- [ownerDispose](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#ownerdispose)
- [refCountReachedZero](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#refcountreachedzero)
- [registerCancellable](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#registercancellable)
- [registerDisposer](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#registerdisposer)
- [registerEventListener](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#registereventlistener)
- [unregisterDisposer](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md#unregisterdisposer)
...
[src/neuroglancer/credentials_provider/shared_counterpart.ts:31](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/034b457d/src/neuroglancer/credentials_provider/shared_counterpart.ts#L31)
...
▸ **addRef**(): [`SharedCredentialsProviderCounterpart`](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md)<`Credentials`\>

#### Returns

[`SharedCredentialsProviderCounterpart`](neuroglancer_credentials_provider_shared_counterpart.SharedCredentialsProviderCounterpart.md)<`Credentials`\>
