[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/uint64\_map](../modules/neuroglancer_uint64_map.md) / Uint64Map

# Class: Uint64Map

[neuroglancer/uint64_map](../modules/neuroglancer_uint64_map.md).Uint64Map
...
- [`WatchableValueInterface`](../interfaces/neuroglancer_trackable_value.WatchableValueInterface.md)<[`Uint64Map`](neuroglancer_uint64_map.Uint64Map.md)\>

## Table of contents

### Constructors

- [constructor](neuroglancer_uint64_map.Uint64Map.md#constructor)

### Properties

- [RPC\_TYPE\_ID](neuroglancer_uint64_map.Uint64Map.md#rpc_type_id)
- [changed](neuroglancer_uint64_map.Uint64Map.md#changed)
- [disposedStacks](neuroglancer_uint64_map.Uint64Map.md#disposedstacks)
- [hashTable](neuroglancer_uint64_map.Uint64Map.md#hashtable)
- [isOwner](neuroglancer_uint64_map.Uint64Map.md#isowner)
- [refCount](neuroglancer_uint64_map.Uint64Map.md#refcount)
- [referencedGeneration](neuroglancer_uint64_map.Uint64Map.md#referencedgeneration)
- [rpc](neuroglancer_uint64_map.Uint64Map.md#rpc)
- [rpcId](neuroglancer_uint64_map.Uint64Map.md#rpcid)
- [unreferencedGeneration](neuroglancer_uint64_map.Uint64Map.md#unreferencedgeneration)
- [wasDisposed](neuroglancer_uint64_map.Uint64Map.md#wasdisposed)

### Accessors

- [size](neuroglancer_uint64_map.Uint64Map.md#size)
- [value](neuroglancer_uint64_map.Uint64Map.md#value)

### Methods

- [[iterator]](neuroglancer_uint64_map.Uint64Map.md#[iterator])
- [addCounterpartRef](neuroglancer_uint64_map.Uint64Map.md#addcounterpartref)
- [addRef](neuroglancer_uint64_map.Uint64Map.md#addref)
- [assignFrom](neuroglancer_uint64_map.Uint64Map.md#assignfrom)
- [clear](neuroglancer_uint64_map.Uint64Map.md#clear)
- [counterpartRefCountReachedZero](neuroglancer_uint64_map.Uint64Map.md#counterpartrefcountreachedzero)
- [delete](neuroglancer_uint64_map.Uint64Map.md#delete)
- [delete\_](neuroglancer_uint64_map.Uint64Map.md#delete_)
- [dispose](neuroglancer_uint64_map.Uint64Map.md#dispose)
- [disposed](neuroglancer_uint64_map.Uint64Map.md#disposed)
- [get](neuroglancer_uint64_map.Uint64Map.md#get)
- [has](neuroglancer_uint64_map.Uint64Map.md#has)
- [initializeCounterpart](neuroglancer_uint64_map.Uint64Map.md#initializecounterpart)
- [initializeSharedObject](neuroglancer_uint64_map.Uint64Map.md#initializesharedobject)
- [ownerDispose](neuroglancer_uint64_map.Uint64Map.md#ownerdispose)
- [refCountReachedZero](neuroglancer_uint64_map.Uint64Map.md#refcountreachedzero)
- [registerCancellable](neuroglancer_uint64_map.Uint64Map.md#registercancellable)
- [registerDisposer](neuroglancer_uint64_map.Uint64Map.md#registerdisposer)
- [registerEventListener](neuroglancer_uint64_map.Uint64Map.md#registereventlistener)
- [set](neuroglancer_uint64_map.Uint64Map.md#set)
- [set\_](neuroglancer_uint64_map.Uint64Map.md#set_)
- [toJSON](neuroglancer_uint64_map.Uint64Map.md#tojson)
- [unregisterDisposer](neuroglancer_uint64_map.Uint64Map.md#unregisterdisposer)
- [makeWithCounterpart](neuroglancer_uint64_map.Uint64Map.md#makewithcounterpart)
...
[src/neuroglancer/uint64_map.ts:31](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L31)
...
• **hashTable**: [`HashMapUint64`](neuroglancer_gpu_hash_hash_table.HashMapUint64.md)

#### Defined in

[src/neuroglancer/uint64_map.ts:30](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L30)
...
[src/neuroglancer/uint64_map.ts:83](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L83)
...
[src/neuroglancer/uint64_map.ts:33](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L33)
...
[src/neuroglancer/uint64_map.ts:65](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L65)
...
▸ **addRef**(): [`Uint64Map`](neuroglancer_uint64_map.Uint64Map.md)
...
| Name | Type |
| :------ | :------ |
| `other` | [`Uint64Map`](neuroglancer_uint64_map.Uint64Map.md) |
...
[src/neuroglancer/uint64_map.ts:87](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L87)
...
[src/neuroglancer/uint64_map.ts:94](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L94)
...
[src/neuroglancer/uint64_map.ts:73](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L73)
...
[src/neuroglancer/uint64_map.ts:69](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L69)
...
[src/neuroglancer/uint64_map.ts:61](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L61)
...
[src/neuroglancer/uint64_map.ts:57](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L57)
...
[src/neuroglancer/uint64_map.ts:47](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L47)
...
[src/neuroglancer/uint64_map.ts:43](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L43)
...
[src/neuroglancer/uint64_map.ts:104](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L104)
...
▸ `Static` **makeWithCounterpart**(`rpc`): [`Uint64Map`](neuroglancer_uint64_map.Uint64Map.md)
...
[src/neuroglancer/uint64_map.ts:37](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/uint64_map.ts#L37)
