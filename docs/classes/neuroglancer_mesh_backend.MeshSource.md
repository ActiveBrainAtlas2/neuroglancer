[neuroglancer](../README.md) / [Exports](../modules.md) / [neuroglancer/mesh/backend](../modules/neuroglancer_mesh_backend.md) / MeshSource

# Class: MeshSource

[neuroglancer/mesh/backend](../modules/neuroglancer_mesh_backend.md).MeshSource
...
- [constructor](neuroglancer_mesh_backend.MeshSource.md#constructor)

### Properties

- [RPC\_TYPE\_ID](neuroglancer_mesh_backend.MeshSource.md#rpc_type_id)
- [chunkManager](neuroglancer_mesh_backend.MeshSource.md#chunkmanager)
- [chunks](neuroglancer_mesh_backend.MeshSource.md#chunks)
- [disposedStacks](neuroglancer_mesh_backend.MeshSource.md#disposedstacks)
- [fragmentSource](neuroglancer_mesh_backend.MeshSource.md#fragmentsource)
- [freeChunks](neuroglancer_mesh_backend.MeshSource.md#freechunks)
- [isOwner](neuroglancer_mesh_backend.MeshSource.md#isowner)
- [refCount](neuroglancer_mesh_backend.MeshSource.md#refcount)
- [referencedGeneration](neuroglancer_mesh_backend.MeshSource.md#referencedgeneration)
- [rpc](neuroglancer_mesh_backend.MeshSource.md#rpc)
- [rpcId](neuroglancer_mesh_backend.MeshSource.md#rpcid)
- [sourceQueueLevel](neuroglancer_mesh_backend.MeshSource.md#sourcequeuelevel)
- [statistics](neuroglancer_mesh_backend.MeshSource.md#statistics)
- [unreferencedGeneration](neuroglancer_mesh_backend.MeshSource.md#unreferencedgeneration)
- [wasDisposed](neuroglancer_mesh_backend.MeshSource.md#wasdisposed)

### Methods

- [addChunk](neuroglancer_mesh_backend.MeshSource.md#addchunk)
- [addCounterpartRef](neuroglancer_mesh_backend.MeshSource.md#addcounterpartref)
- [addRef](neuroglancer_mesh_backend.MeshSource.md#addref)
- [chunkStateChanged](neuroglancer_mesh_backend.MeshSource.md#chunkstatechanged)
- [counterpartRefCountReachedZero](neuroglancer_mesh_backend.MeshSource.md#counterpartrefcountreachedzero)
- [dispose](neuroglancer_mesh_backend.MeshSource.md#dispose)
- [disposed](neuroglancer_mesh_backend.MeshSource.md#disposed)
- [download](neuroglancer_mesh_backend.MeshSource.md#download)
- [downloadFragment](neuroglancer_mesh_backend.MeshSource.md#downloadfragment)
- [getChunk](neuroglancer_mesh_backend.MeshSource.md#getchunk)
- [getFragmentChunk](neuroglancer_mesh_backend.MeshSource.md#getfragmentchunk)
- [getNewChunk\_](neuroglancer_mesh_backend.MeshSource.md#getnewchunk_)
- [initializeCounterpart](neuroglancer_mesh_backend.MeshSource.md#initializecounterpart)
- [initializeSharedObject](neuroglancer_mesh_backend.MeshSource.md#initializesharedobject)
- [ownerDispose](neuroglancer_mesh_backend.MeshSource.md#ownerdispose)
- [refCountReachedZero](neuroglancer_mesh_backend.MeshSource.md#refcountreachedzero)
- [registerCancellable](neuroglancer_mesh_backend.MeshSource.md#registercancellable)
- [registerChunkListener](neuroglancer_mesh_backend.MeshSource.md#registerchunklistener)
- [registerDisposer](neuroglancer_mesh_backend.MeshSource.md#registerdisposer)
- [registerEventListener](neuroglancer_mesh_backend.MeshSource.md#registereventlistener)
- [removeChunk](neuroglancer_mesh_backend.MeshSource.md#removechunk)
- [unregisterChunkListener](neuroglancer_mesh_backend.MeshSource.md#unregisterchunklistener)
- [unregisterDisposer](neuroglancer_mesh_backend.MeshSource.md#unregisterdisposer)
...
▸ **addRef**(): [`MeshSource`](neuroglancer_mesh_backend.MeshSource.md)
...
[src/neuroglancer/mesh/backend.ts:300](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/91617476/src/neuroglancer/mesh/backend.ts#L300)
