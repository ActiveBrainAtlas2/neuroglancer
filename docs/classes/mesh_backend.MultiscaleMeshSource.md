[neuroglancer](../README.md) / [Modules](../modules.md) / [mesh/backend](../modules/mesh_backend.md) / MultiscaleMeshSource

# Class: MultiscaleMeshSource

[mesh/backend](../modules/mesh_backend.md).MultiscaleMeshSource
...
- [constructor](mesh_backend.MultiscaleMeshSource.md#constructor)

### Properties

- [RPC\_TYPE\_ID](mesh_backend.MultiscaleMeshSource.md#rpc_type_id)
- [chunkManager](mesh_backend.MultiscaleMeshSource.md#chunkmanager)
- [chunks](mesh_backend.MultiscaleMeshSource.md#chunks)
- [disposedStacks](mesh_backend.MultiscaleMeshSource.md#disposedstacks)
- [format](mesh_backend.MultiscaleMeshSource.md#format)
- [fragmentSource](mesh_backend.MultiscaleMeshSource.md#fragmentsource)
- [freeChunks](mesh_backend.MultiscaleMeshSource.md#freechunks)
- [isOwner](mesh_backend.MultiscaleMeshSource.md#isowner)
- [refCount](mesh_backend.MultiscaleMeshSource.md#refcount)
- [referencedGeneration](mesh_backend.MultiscaleMeshSource.md#referencedgeneration)
- [rpc](mesh_backend.MultiscaleMeshSource.md#rpc)
- [rpcId](mesh_backend.MultiscaleMeshSource.md#rpcid)
- [sourceQueueLevel](mesh_backend.MultiscaleMeshSource.md#sourcequeuelevel)
- [statistics](mesh_backend.MultiscaleMeshSource.md#statistics)
- [unreferencedGeneration](mesh_backend.MultiscaleMeshSource.md#unreferencedgeneration)
- [wasDisposed](mesh_backend.MultiscaleMeshSource.md#wasdisposed)

### Methods

- [addChunk](mesh_backend.MultiscaleMeshSource.md#addchunk)
- [addCounterpartRef](mesh_backend.MultiscaleMeshSource.md#addcounterpartref)
- [addRef](mesh_backend.MultiscaleMeshSource.md#addref)
- [chunkStateChanged](mesh_backend.MultiscaleMeshSource.md#chunkstatechanged)
- [counterpartRefCountReachedZero](mesh_backend.MultiscaleMeshSource.md#counterpartrefcountreachedzero)
- [dispose](mesh_backend.MultiscaleMeshSource.md#dispose)
- [disposed](mesh_backend.MultiscaleMeshSource.md#disposed)
- [download](mesh_backend.MultiscaleMeshSource.md#download)
- [downloadFragment](mesh_backend.MultiscaleMeshSource.md#downloadfragment)
- [getChunk](mesh_backend.MultiscaleMeshSource.md#getchunk)
- [getFragmentChunk](mesh_backend.MultiscaleMeshSource.md#getfragmentchunk)
- [getNewChunk\_](mesh_backend.MultiscaleMeshSource.md#getnewchunk_)
- [initializeCounterpart](mesh_backend.MultiscaleMeshSource.md#initializecounterpart)
- [initializeSharedObject](mesh_backend.MultiscaleMeshSource.md#initializesharedobject)
- [ownerDispose](mesh_backend.MultiscaleMeshSource.md#ownerdispose)
- [refCountReachedZero](mesh_backend.MultiscaleMeshSource.md#refcountreachedzero)
- [registerCancellable](mesh_backend.MultiscaleMeshSource.md#registercancellable)
- [registerChunkListener](mesh_backend.MultiscaleMeshSource.md#registerchunklistener)
- [registerDisposer](mesh_backend.MultiscaleMeshSource.md#registerdisposer)
- [registerEventListener](mesh_backend.MultiscaleMeshSource.md#registereventlistener)
- [removeChunk](mesh_backend.MultiscaleMeshSource.md#removechunk)
- [unregisterChunkListener](mesh_backend.MultiscaleMeshSource.md#unregisterchunklistener)
- [unregisterDisposer](mesh_backend.MultiscaleMeshSource.md#unregisterdisposer)
...
[src/neuroglancer/mesh/backend.ts:483](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L483)
...
[src/neuroglancer/mesh/backend.ts:481](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L481)

___

### fragmentSource

• **fragmentSource**: [`MultiscaleFragmentSource`](mesh_backend.MultiscaleFragmentSource.md)

#### Defined in

[src/neuroglancer/mesh/backend.ts:480](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L480)
...
▸ **addRef**(): [`MultiscaleMeshSource`](mesh_backend.MultiscaleMeshSource.md)
...
[src/neuroglancer/mesh/backend.ts:475](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L475)

___

### getChunk

▸ **getChunk**(`objectId`): [`MultiscaleManifestChunk`](mesh_backend.MultiscaleManifestChunk.md)
...
[src/neuroglancer/mesh/backend.ts:491](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L491)

___

### getFragmentChunk

▸ **getFragmentChunk**(`manifestChunk`, `lod`, `chunkIndex`): [`MultiscaleFragmentChunk`](mesh_backend.MultiscaleFragmentChunk.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `manifestChunk` | [`MultiscaleManifestChunk`](mesh_backend.MultiscaleManifestChunk.md) |
| `lod` | `number` |
| `chunkIndex` | `number` |
...
[src/neuroglancer/mesh/backend.ts:502](https://github.com/ActiveBrainAtlas2/neuroglancer/blob/1beb5d34/src/neuroglancer/mesh/backend.ts#L502)
