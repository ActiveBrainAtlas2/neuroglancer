[neuroglancer](../README.md) / [Modules](../modules.md) / [util/geom](../modules/util_geom.md) / vec4
...
- [create](util_geom.vec4.md#create)
...
▸ `Static` **copy**(`out`, `a`): [`vec4`](util_geom.vec4.md)
...
▸ `Static` **floor**(`out`, `a`): [`vec4`](util_geom.vec4.md)
